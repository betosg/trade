...
<html>
	<head>
		...
		<script language="javascript" type="text/javascript">
			...
			function ok() {
				strLocation = "../miniapp_relacAreaCobertura/index.php?var_chavereg=<?php echo $var_cod_cad;?>";
				submeterForm();
			}
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	<input type="hidden" name="DEFAULT_TABLE" 			value="relac_area_cobertura" />
	<input type="hidden" name="DEFAULT_DB" 				value="<?php echo(CFG_DB);?>" />
	<input type="hidden" name="FIELD_PREFIX" 			value="DBVAR_" />
	<input type="hidden" name="RECORD_KEY_NAME" 		value="cod_area_cobertura" />
		...
		<tr>
			<td align="left" valign="top" style="padding:10px 50px 0px 50px;">
				<table cellspacing="2" cellpadding="3" border="0" width="100%">
					...
					<tr bgcolor="<?php echo(getLineColor($strColor));?>">
						<td width="27%" align="right"><strong>Estado:</strong></td>
						<td width="73%" align="left"><?php echo(getValue($objRS,"estado"));?></td>
					</tr>					
					<tr bgcolor="<?php echo(getLineColor($strColor));?>">
						<td width="27%" align="right"><strong>Município:</strong></td>
						<td width="73%" align="left"> <?php echo(getValue($objRS,"municipio"));?>
						</td>
					</tr>
					<tr bgcolor="<?php echo(getLineColor($strColor));?>">
						<td width="27%" align="right"><strong>Coord. GPS:</strong></td>
						<td width="73%" align="left"> <?php echo(getValue($objRS,"coord_gps"));?>
						</td>
					</tr>
