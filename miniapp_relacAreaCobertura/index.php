...
<?php
	...
	$strSQL = "	select t2.cod_area_cobertura as codigo, t4.nome as estado, t3.nome as municipio, t2.coord_gps
				from cad_pj t1
					INNER JOIN relac_area_cobertura t2 on t1.cod_pj = t2.cod_pj
...
<body bgcolor="#FFFFFF">
	...
	<table cellpadding="0" cellspacing="0" width="100%" class="menu_css">
		<tr>
			...
			<?php
				athBeginCssMenu();
					athCssMenuAddItem("","_self","Área Cobertura",1);
					athBeginCssSubMenu();								
						athCssMenuAddItem("STinsAreaCobertura.php?var_codigo=".$intCodCadastro,"_self","Inserir");
					athEndCssSubMenu();
				athEndCssMenu();		
			?>
			</td>
	...
	if($objResult->rowCount() == 0) {
		mensagem("alert_consulta_vazia_titulo","alert_consulta_vazia_desc","Não há cidades cadastradas.","","aviso",1,"","","");
	} else {
	?>
	...
	<table align="center" cellpadding="0" cellspacing="1" style="width:100%;" class="tablesort">
		<thead>
			<tr>
				...
				<th width="20%" class="sortable" nowrap>UF</th>
				<th width="45%" class="sortable" nowrap>Município</th>
				<th width="20%" class="sortable" nowrap>Coord. GPS</th>
        	...
        	<tr bgcolor="<?php echo(getLineColor($strColor));?>">
				<td align="center" style="vertical-align:middle;">
					<img src="../img/icon_trash.gif" alt="deletar" 
						 ...
						 onClick="linkPage('STdelAreaCobertura.php?var_cod_dado=<?php echo(getValue($objRS,"codigo"));?>&var_cod_cad=<?PHP echo $intCodCadastro; ?>');" />				</td>
				<td align="center" style="vertical-align:middle;">
					<img src="../img/icon_write.gif" alt="editar" 
						 title="editar"
						 border="0" style="cursor:pointer;" 
						 onClick="linkPage('STupdAreaCobertura.php?var_cod_dado=<?php echo(getValue($objRS,"codigo"));?>&var_cod_cad=<?PHP echo $intCodCadastro; ?>');" />				</td>
				<!--td align="left" style="vertical-align:middle;">
					<img src="../img/icon_zoom.gif" alt="<?php echo(getTText("visualizar",C_NONE));?>" 
						 title="<?php echo(getTText("visualizar",C_NONE));?>"
						 border="0" style="cursor:pointer;" 
						 onClick="linkPage('STvieAreaCobertura.php?var_cod_dado=<?php echo(getValue($objRS,"codigo"));?>&var_cod_cad=<?PHP echo $intCodCadastro; ?>');" />				</td//-->		
				<td align="left"><?php echo(getValue($objRS,"codigo")); ?></td>
				<td align="left"><?php echo(strtoupper(getValue($objRS,"estado"))); ?></td>
				<td align="left"><?php echo(getValue($objRS,"municipio")); ?></td>				
				<td align="left"><?php echo(getValue($objRS,"coord_gps")); ?></td>				
			</tr>
