...
<html>
	<head>
		...
		<script language="javascript" type="text/javascript">
			...
			function cancelar() {
				window.location = "../miniapp_relacAreaCobertura/index.php?var_chavereg=<?php echo $intcodigo;?>";
			}
			...
			function listaMunicipio(prCodEstado){
				...
				xhttp.onreadystatechange = function() {
					if (this.readyState == 4 && this.status == 200) {
						...
						//strReturn =  this.responseText.split("|")
						//for i=0;strReturn.len
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	<form name="formstatic" action="STinsAreaCoberturaExec.php" method="POST" />
				...
				<table cellspacing="2" cellpadding="3" border="0" width="100%">
					...
					<tr bgcolor="#FFFFFF">
						...
						<td width="73%" align="left" class="destaque_gde">
							<strong>Área de Cobertura</strong></td>
					</tr>
					...
					<tr bgcolor="<?php echo(getLineColor($strColor));?>">
						...
						<td width="73%" align="left">
							...
							<?php  echo (montaCombo($objConn, "SELECT nome as uf, cod_estado from lc_estado order by nome", "cod_estado", "uf", "", ""));?>
						</td>
					</tr>					
					<tr bgcolor="<?php echo(getLineColor($strColor));?>">
					...
					<tr bgcolor="<?php echo(getLineColor($strColor));?>">
						...
						<td width="73%" align="left">
                            <input type="text" name="DBVAR_STR_COORD_GPS" id="DBVAR_STR_COORD_GPS" style="width:200px;" maxlength="255" value=""/>							
					</tr>
