...
// recebimento da base de dados para uso externo - CAPA
...
?>
	...
	function retorna(prValue, prLabel){ 
		parent.window.opener.document.getElementById('<?php echo $strCampoRet;?>').value = parent.window.opener.document.getElementById('<?php echo $strCampoRet;?>').value + prValue+";";
		//parent.window.opener.ajaxCopiaEnderContabil(prValue,<?php echo("'".$strSystem."'");?>);
		parent.window.close();
	}
