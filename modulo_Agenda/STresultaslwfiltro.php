...
$strSystem     = (request("var_db") == "") ? getsession("cemisys_db_name") : request("var_db"); 
 
$strSesPfx = strtolower(str_replace("modulo_","",basename(getcwd())));
 
$strNome       = "formstatic";
$strSQLSearch  = "SELECT cod_usuario, id_usuario, grp_user FROM sys_usuario WHERE id_usuario <=> '?%'";
$strDBCampoRet = "id_usuario";
$strDBCampoLbl = "";
$strDialogGrp  = "000";
$strLabel      = "id_usuario";
$strAcao       = "single";
$strCampoRet   = "var_citados";
