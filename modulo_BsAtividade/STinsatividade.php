...
<!-- USO -->
<center>
<?php athBeginFloatingBox("710","",getTText("bs_atividade",C_UCWORDS)." - (".getTText("insercao",C_NONE).")",CL_CORBAR_GLASS_1); ?>
<form name="formstatic" action="STinsatividadeexec.php" method="post">
		...
		<td align="left" valign="top" style="padding:10px 70px 10px 70px;">
			<table cellspacing="2" cellpadding="4" border="0" width="100%">
				...
				<tr bgcolor="<?php echo(getLineColor($strColor));?>">
					...
					<td align="left">
						<table border="0px" cellpadding="0px" cellspacing="0px">
							<tr>
								<td style="padding-right:5px;" valign="middle"><input name="var_bs_codigo" id="var_bs_codigo" class='edtext' type='text' maxlength='10' value="" onKeyPress="Javascript:return validateNumKey(event);" style="width:40px;"></td>
								<td style="padding-right:3px;" valign="middle">
									<select name="var_bs_tipo" id="var_bs_tipo" class="edtext" size="1" style="width:120px;">
										...
										<option value="cad_pj" selected="selected"><?php echo(getTText("pessoa_juridica", C_UCWORDS))?></option>
				...
				<tr bgcolor="<?php echo(getLineColor($strColor));?>">
					...
					<td align="left"><input type="text" name="var_bs_titulo" id="var_bs_titulo" value="" maxlength="250" size="60" /></td>
				</tr>
				<tr bgcolor="<?php echo(getLineColor($strColor));?>">
				...
				<tr bgcolor="<?php echo(getLineColor($strColor));?>">
					...
					<td align="left">
						<select name="var_bs_categoria" id="var_bs_categoria" style="width:150px;">
							<?php echo(montaCombo($objConn,"SELECT bs_categoria.cod_categoria, UPPER(bs_categoria.cod_categoria||' - '||bs_categoria.nome) AS nome FROM bs_categoria WHERE dtt_inativo IS NULL","cod_categoria","nome",""));?>
						</select>
					</td>
				</tr>
				<tr bgcolor="<?php echo(getLineColor($strColor));?>">
				...
				<!--tr bgcolor="<php echo(getLineColor($strColor));?>">
					...
					<td align="left">
						<input type="text" name="var_bs_equipe" id="var_bs_equipe" size="60" />
				...
				<tr bgcolor="<?php echo(getLineColor($strColor));?>">
					...
					<td align="left">
						<input type="radio" name="var_bs_modelo" id="var_bs_modelo" value="S" class="inputclean">
						<?php echo(getTText("sim",C_NONE));?>&nbsp;
						<input type="radio" name="var_bs_modelo" id="var_bs_modelo" value="N" class="inputclean" checked="checked">
				...
				<tr bgcolor="<?php echo(getLineColor($strColor));?>">
					...
					<td align="left"><textarea name="var_bs_descricao" id="var_bs_descricao" style="width:350px;height:120px;"></textarea></td>
				</tr>
				<tr>
