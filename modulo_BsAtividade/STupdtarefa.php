<?php
	...
	if((getsession(CFG_SYSTEM_NAME."_id_usuario") != getValue($objRS,"id_responsavel")) && (getValue($objRS,"situacao") == "fechado")){
...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function aplicar() {
				if(validaCampos()){
					strLocation = "../modulo_Todolist/STupdtarefa.php?var_chavereg=<?php echo($intCodDado);?>&var_location=<?php echo($strLocation);?>";
					submeterForm();
				} else{
					return(false);
				}
...
<script type="text/javascript">document.getElementById('var_todo_titulo').focus();</script>
</body>
</html>