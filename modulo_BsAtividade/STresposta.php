...
function deleteResposta(prCodResposta, prCodTodolist, prOper){
	if(confirm("<?php echo(getTText("confirm_delete_chamado",C_NONE)); ?>")){
		location.href = "STdelresposta.php?var_chavereg=" + prCodResposta + "&var_cod_todolist=" + prCodTodolist + "&var_oper=" + prOper;
	}
}
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
 <tr>
   <td align="center" valign="top">
	<?php athBeginFloatingBox("600","none",getTText(getsession($strSesPfx . "_titulo"),C_TOUPPER) . " - " . getTText("nova_resposta",C_UCWORDS),CL_CORBAR_GLASS_1); ?>
			...
			<tr>
				<td align="center" valign="top">
					<table width="550" border="0" cellspacing="0" cellpadding="4">
						...
						<tr>
							<td bgcolor="<?php echo(CL_CORLINHA_2); ?>" width="100" align="right"><b><?php echo(getTText("descricao",C_UCWORDS)); ?>:&nbsp;</b></td>
						...
						<form name="forminsresposta" action="STrespostaexec.php" method="post">
						...
						<tr>
							<td align="right" colspan="2" style="padding:10px 0px 10px 10px;">
								<button onClick="location.href='<?php echo(getsession($strSesPfx . "_grid_default")); ?>';"><?php echo(getTText("ok",C_UCWORDS)); ?></button>
							</td>
						</tr>
						<?php } ?>
					</table>
