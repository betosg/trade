								...
								<tr bgcolor="<?php echo($strColor); ?>" onMouseOver="intCurrentPosMouse = this.rowIndex;navigateRow(event);">
									<td width="<?php echo(ICONES_WIDTH * ICONES_NUM); ?>">
										<table border="0" cellspacing="0" cellpadding="0" width="<?php echo(CL_LINK_WIDTH * ICONES_NUM); ?>">
											<tr>
												<td width="<?php echo(ICONES_WIDTH)?>"><a href="../modulo_Todolist/STupdtarefa.php?var_chavereg=<?php echo(getValue($objRS,"cod_todolist"));?>&var_location=../modulo_PainelTodolist/STindex.php" ><img src="../img/icon_write.gif" border="0" title="<?php echo(getTText("editar",C_NONE));?>" /></a></td>
												<td width="<?php echo(ICONES_WIDTH)?>"><a href="../modulo_Todolist/STvietarefa.php?var_chavereg=<?php echo(getValue($objRS,"cod_todolist"));?>&var_location=../modulo_PainelTodolist/STindex.php" ><img src="../img/icon_zoom.gif" border="0" title="<?php echo(getTText("visualizar",C_NONE));?>" /></a></td>
												<td width="<?php echo(ICONES_WIDTH)?>"><img src="../img/icon_respostas.gif" border="0" title="<?php echo(getTText("respostas",C_NONE));?>" style="cursor:pointer;" onClick="AbreJanelaPAGE('../modulo_Todolist/STifrrespostas.php?var_chavereg=<?php echo(getValue($objRS,"cod_todolist"));?>',800,700);" /></td>
												<td width="<?php echo(ICONES_WIDTH)?>"><a href="../modulo_Todolist/STfinalizartarefa.php?var_chavereg=<?php echo(getValue($objRS,"cod_todolist"));?>&var_location=../modulo_PainelTodolist/STindex.php" ><img src="../img/icon_confirmar_homologacao.gif" border="0" title="<?php echo(getTText("finalizar",C_NONE));?>" /></a></td>
											</tr>
										</table>
									</td>
