<?php
	...
	if($intCodDado == ""){
		mensagem("err_sql_desc_card","err_envio_ag",getTText("cod_null",C_NONE),'','erro','1');
		die();
	}
	...
	try{
		$strSQL = "SELECT bs_atividade.id_responsavel FROM bs_atividade WHERE bs_atividade.cod_atividade = ".$intCodDado;
	...
	if(getsession(CFG_SYSTEM_NAME."_id_usuario") != getValue($objRS,"id_responsavel")){
		mensagem("err_sql_titulo","aviso_atividade_nao_te_pertence","",$strRedirect,"aviso",1,"1");
		die();
	}
	...
	<head>
		...
		<script type="text/javascript">
			...
			function ajaxBuscaUsuario(){
				...
				// monta o SQL
				strSQL = "SELECT id_usuario, id_usuario FROM sys_usuario WHERE 1=1 ";
				...
				ajaxDetailData(strSQL,'ajaxMontaComboNotNull','var_usuarios_d','');
...
<!-- USO -->
<center>
<?php athBeginFloatingBox("580","",getTText("equipe_title",C_UCWORDS),CL_CORBAR_GLASS_2); ?>
<table cellpadding="0" cellspacing="0" border="0" height="315" width="550" bgcolor="#FFFFFF">
	<tr>
		<td align="left" valign="top" style="padding:15px 0px 0px 15px;">
			...
			<?php athBeginFloatingBox("200","220","<span id='img_search' style='display:none;cursor:pointer;' onclick='changeTables();'><img src='../img/icon_search.gif' style='float:right'></span>"."<span style='padding-left:5px;'>".getTText("usuarios_d",C_UCWORDS)."</span>",CL_CORBAR_GLASS_2); ?>
			...
			<table cellspacing="0" cellpadding="0" border="0" bgcolor="#FFFFFF" id="table_filtro">
				...
				<tr class="tr_filtro_field">
					<td><input type="text" name="var_search_cod_usuario" size="5"maxlength="10" onKeyPress="return validateNumKey(event);" onKeyDown="handleEnter(event);"/></td>
				</tr>
				<tr class="tr_filtro_label">
					<td><?php echo(getTText("id_usuario",C_UCWORDS));?>:</td>
				</tr>
				<tr class="tr_filtro_field">
					<td><input type="text"name="var_search_id_usuario"size="38"maxlength="120" onKeyPress="handleEnter(event);"/>
					</td>
				</tr>
				<tr class="tr_filtro_label">
				...
				<tr class="tr_filtro_field">
					<td>
						<select name="var_search_grp_user" style="width:120px;" onKeyPress="handleEnter(event);"/>
							<option value="" selected="selected"></option>
							<?php echo(montaCombo($objConn,"SELECT DISTINCT grp_user FROM sys_usuario",'grp_user','grp_user',$strDefaultGrp,''));?>
						</select>
					</td>
				</tr>
				...
				<tr>
					<td width="100%">
						<form name="formstatic_0">
							<select multiple="multiple" name="var_usuarios_d" id="var_usuarios_d" style="width:100%;border:1px solid #C9C9C9;" size="11"></select>
						</form>
		...
		<td align="left" valign="top" style="padding:15px 15px 0px 0px;">
			...
			<?php athBeginFloatingBox("200","220",getTText("equipe_atual",C_UCWORDS),CL_CORBAR_GLASS_2); ?>
			<form name="formstatic" action="STequipeexec.php" method="post">
			...
			<table cellpadding="0" cellspacing="0" border="0" width="180">
				<tr>
					<td>
						<select multiple="multiple" name="var_citados_s" id="var_citados_s" style="width:100%;border:1px solid #C9C9C9;" size="15">
						 <?php echo(montaCombo($objConn,"SELECT id_usuario FROM bs_equipe WHERE cod_atividade = ".$intCodDado,"id_usuario","id_usuario",''));?>
						</select>
					</td>
				</tr>
			</table> 									
	...
	<tr><td colspan="3"><table cellpadding="0" cellspacing="0" border="0" width="98%"><tr><td style="border-top:0px;">&nbsp;</td></tr></table></td></tr>
	<tr><td colspan="3"><table cellpadding="0" cellspacing="0" border="0" width="98%"><tr><td style="border-top:0px;">&nbsp;</td></tr></table></td></tr>
			...
			<table cellspacing="0" cellpadding="0" border="0" width="100%">
				...
				<tr>
					...
					<td width="10%" align="left">
						<button onClick="selectOptions('var_citados_s');goNext('formstatic');">
							<?php echo(getTText("ok",C_NONE));?>
						</button>
					</td>
