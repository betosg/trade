...
<html>
	<head>
		...
		<!--
			...
			function ok() {
				strLocation = "../modulo_FinFluxoCaixa/STifrlancamento.php?var_chavereg=<?php echo($intCodTitulo)?>";
				submeterForm();
			}

			function cancelar() {
				document.location.href = "../modulo_FinFluxoCaixa/STifrlancamento.php?var_chavereg=<?php echo($intCodTitulo)?>";
			}

			function aplicar() {
				strLocation = "../modulo_FinFluxoCaixa/STinslctoordinario.php?var_chavereg=<?php echo($intCodTitulo)?>";
				submeterForm();
			}
