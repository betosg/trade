 ...
 <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
  <tr>
	<td width="24" valign="top">
		<img id="img_collapse" src="../img/collapse_open.gif" onClick="swapwidth(250,'<?php echo(CFG_SYSTEM_THEME); ?>','<?php echo(CFG_SYSTEM_NAME); ?>');" style="cursor:pointer">
	</td>
	<td valign="top" style="padding-top:10px;">
		<?php
		 include_once("_STincludemenu.php");
		 echo("<br><br>");
		 //include_once("_STincludebookmark.php");
		?>
	</td>
  </tr>
 </table>
