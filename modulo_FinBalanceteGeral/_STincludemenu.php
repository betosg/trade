				...
				<table id="" border="0" cellpadding="0" cellspacing="0" width="100%" style="display:block">
					<tr>
						<td align="left" valign="top" style="padding-left:5px;">
							...
							<br>
							<input type="text" name="var_dt_ini" size="12" maxlength="10"
							 onkeypress="return validateNumKey(event);" onkeydown="FormataInputData(this,event);"
							 value="<?php echo(dDate(CFG_LANG,dateNow(),false));?>">
						</td>
					</tr>
					...
					<tr>
						<td align="left" valign="top" style="padding-left:5px;">
							...
							<br>
							<input type="text" name="var_dt_fim" size="12" maxlength="10"
							 onkeypress="return validateNumKey(event);" onkeydown="FormataInputData(this,event);"
							 value="<?php echo(dDate(CFG_LANG,dateNow(),false));?>">
						</td>
					</tr>
					...
					<!--tr>
						<td align="left" valign="top" style="padding-left:5px;">
							...
							<br>
							<select name="var_conta_banco" style="width:120px;">
								<option value="" selected="selected"><?php echo(getTText("selecione",C_UCWORDS)); ?>...</option>
								<?php echo(montaCombo($objConn,"SELECT cod_conta, cod_conta||' - '||nome AS
																nome FROM fin_conta WHERE dtt_inativo IS NULL",
																"cod_conta","nome",""));?>
							</select>
						</td>
					</tr-->
					...
					<!--tr>
						<td align="left" valign="top" style="padding-left:5px;">
							...
							<select name="var_plano_conta" style="width:180px;">
								<option value="" selected="selected"><?php echo(getTText("selecione",C_UCWORDS)); ?>...</option>
								<?php echo(montaCombo($objConn,"SELECT cod_plano_conta, cod_reduzido||' - '||nome AS nome
																FROM fin_plano_conta WHERE dtt_inativo IS NULL ORDER BY
																cod_reduzido","cod_plano_conta","nome",""));?>
							</select>
						</td>
					</tr-->
				</table>
