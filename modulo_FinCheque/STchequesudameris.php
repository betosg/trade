...
<head>
	...
	<title><?php echo(strtoupper(CFG_SYSTEM_NAME)." - ".getTText("cheque",C_NONE)." ".getTText("bradesco",C_NONE));?></title>
		...
		<td width="661" style="background-image:url(../img/<?php echo(getValue($objRS,"modelo_cheque_img"));?>);">
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%" height="100%" style="vertical-align:top;text-align:left;">
				...
				<tr height="29" >
					...
					<tr>
						<td width="325">&nbsp;</td>
						<td width="97" class="sans cidade"><?php echo(getValue($objRS,"cidade_assinatura"));?></td>
						<td width="63"  class="sans" valign="bottom">
							<?php 
								$dtAssinatura = dDate(CFG_LANG,getValue($objRS,"datacheque"),false);
								$dtAssinatura = explode("/",$dtAssinatura);
								echo("&nbsp;&nbsp;&nbsp;".$dtAssinatura[0]);
							?>						</td>
						<td width="136" class="sans mesano">
							<?php
								echo("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
								echo(ucwords(getMesExtensoFromMes($dtAssinatura[1])));
							?>						</td>
						<td width="39" class="sans mesano">
