...
<head>
	...
	<title><?php echo(strtoupper(CFG_SYSTEM_NAME)." - ".getTText("cheque",C_NONE)." ".getTText("unibanco",C_NONE));?></title>
...
<body style="width:100%;height:100%;background:#FFF;margin-top:287px;margin-left:0px;" onLoad="window.resizeTo(700,380);window.print();">
	...
	<tr>
		...
		<td width="661" style="background-image:url(../img/<?php echo(getValue($objRS,"modelo_cheque_img"));?>);">
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%" height="100%" style="vertical-align:top;text-align:left;">
				...
				<tr height="40">
					<td class="serif extenso">
						...
						<?php 
							...
							$intRangeChar = (($intQtdeChar >  0) && ($intQtdeChar <=  30)) ? ( 87 - $intQtdeChar) : $intRangeChar;
							$intRangeChar = (($intQtdeChar > 30) && ($intQtdeChar <=  40)) ? ( 95 - $intQtdeChar) : $intRangeChar;
							$intRangeChar = (($intQtdeChar > 40) && ($intQtdeChar <=  50)) ? (100 - $intQtdeChar) : $intRangeChar;
							$intRangeChar = (($intQtdeChar > 50) && ($intQtdeChar <=  60)) ? (107 - $intQtdeChar) : $intRangeChar;
							$intRangeChar = (($intQtdeChar > 60) && ($intQtdeChar <=  70)) ? (112 - $intQtdeChar) : $intRangeChar;
							$intRangeChar = (($intQtdeChar > 70) && ($intQtdeChar <=  80)) ? (117 - $intQtdeChar) : $intRangeChar;
							$intRangeChar = (($intQtdeChar > 80) && ($intQtdeChar <=  90)) ? (122 - $intQtdeChar) : $intRangeChar;
							$intRangeChar = (($intQtdeChar > 90) && ($intQtdeChar <= 105)) ? (125 - $intQtdeChar) : $intRangeChar;
							$intRangeChar = ($intQtdeChar  > 105) ? (137 - $intQtdeChar) : $intRangeChar;
				...
				<!-- LINHA CEDENTE -->
				<tr height="27"><td class="serif cedente"><?php echo(($boolNominal == "1") ? getValue($objRS,"cedente") : "");?></td></tr>
				<!-- LINHA CEDENTE -->
				...
				<tr height="26" >
					...
					<tr>
						<td width="320">&nbsp;</td>
						<td width="80" class="sans cidade"><?php echo(getValue($objRS,"cidade_assinatura"));?></td>
						<td width="62"  class="sans" valign="bottom">
							<?php 
						...
						<td width="130" class="sans mesano">
							<?php
								echo("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
								echo(ucwords(getMesExtensoFromMes($dtAssinatura[1])));
							?>
						</td>
						<td width="54" class="sans mesano">
							<?php //echo(substr($dtAssinatura[2],2,4));?>
							<?php echo($dtAssinatura[2]);?>						
						</td>
					</tr>
					</table>
					</td>
