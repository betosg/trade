...
<head>
	...
	<title><?php echo(strtoupper(CFG_SYSTEM_NAME)." - ".getTText("cheque",C_NONE)." ".getTText("bic",C_NONE));?></title>
		...
		<td width="661" style="background-image:url(../img/<?php echo(getValue($objRS,"modelo_cheque_img"));?>);">
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%" height="100%" style="vertical-align:top;text-align:left;">
				...
				<tr height="26" >
					...
					<tr>
						<td width="296">&nbsp;</td>
						<td width="111" class="sans cidade"><?php echo(getValue($objRS,"cidade_assinatura"));?></td>
						<td width="69"  class="sans" valign="bottom">
							<?php 
						...
						<td width="135" class="sans mesano">
							<?php
								echo("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
								echo(ucwords(getMesExtensoFromMes($dtAssinatura[1])));
							?>
						</td>
						<td width="49" class="sans mesano">
