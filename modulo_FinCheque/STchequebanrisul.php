...
<head>
	...
	<title><?php echo(strtoupper(CFG_SYSTEM_NAME)." - ".getTText("cheque",C_NONE)." ".getTText("banrisul",C_NONE));?></title>
	...
	<tr>
		...
		<td width="633" style="background-image:url(../img/<?php echo(getValue($objRS,"modelo_cheque_img"));?>);">
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%" height="100%" style="vertical-align:top;text-align:left;">
				<tr height="39"><td width="100%" class="serif valor" align="right"><?php echo("#".number_format((double) getValue($objRS,"valorcheque"),2,',','.')."#");?></td></tr>
				...
				<tr height="20" >
					...
					<tr>
						<td width="307">&nbsp;</td>
						<td width="163" class="sans cidade"><?php echo(getValue($objRS,"cidade_assinatura"));?></td>
						<td width="33"  class="sans" valign="bottom">
							<?php 
						...
						<td width="130" class="sans mesano">
							...
							?>						</td>
						<td width="27" class="sans mesano" style="font-size:10px;">
