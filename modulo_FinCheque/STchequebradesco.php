...
<body style="width:100%;height:100%;background:#FFF;margin-top:0px;margin-left:0px;" onLoad="window.resizeTo(700,380);window.print();">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="661" height="235" align="center">
	<tr>
		<td width="0">
		...
		<td width="633" style="background-image:url(../img/<?php echo(getValue($objRS,"modelo_cheque_img"));?>);">
			...
			<div style="position:absolute; z-index:9999; width:300px; height:136px; top: 0px;">
	  ...
	  <table cellpadding="0" cellspacing="0" border="0" width="100%" height="100%" style="vertical-align:top;text-align:left;">
				<tr height="30"><td width="100%" class="serif valor" align="right"><?php echo("#".number_format((double) getValue($objRS,"valorcheque"),2,',','.')."#");?></td></tr>
				...
				<!-- LINHA CEDENTE -->
				<tr height="25"><td class="serif cedente"><?php echo(($boolNominal == "1") ? getValue($objRS,"cedente") : "");?></td></tr>
				<!-- LINHA CEDENTE -->
				...
				<tr height="20" >
					...
					<tr>
						<td width="260">&nbsp;</td>
						<td width="145" class="sans cidade"><?php echo(getValue($objRS,"cidade_assinatura"));?></td>
						<td width="65"  class="sans" valign="bottom">
							<?php 
