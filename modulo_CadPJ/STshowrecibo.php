<?php
	...
	try{
		$strSQL = "
			...
			WHERE fin_conta_pagar_receber.cod_conta_pagar_receber = ".$intTITULO;
		//Die($strSQL);
	...
	try{
		$strSQL    = "SELECT cod_conta_pagar_receber FROM fin_conta_pagar_receber WHERE cod_agrupador = ".$intTITULO.";";
	...
	<head>
		...
		<script type="text/javascript">
			...
			function ok() {
				...
				AbreJanelaPAGE('<?php echo($strActionForm."?var_chavereg=".$intTITULO."&var_nome_sacado=");?>'+strNomeSacado+"&var_duas_vias="+strCheck2Vias,'800','600');
				document.location.href = "../modulo_CadPJ/STifrrecibos.php?var_chavereg=<?php echo($intTITULO);?>&var_cod_conta_pagar_receber=<?php echo($intTITULO);?>&var_cod_resize=<?php echo($intCodDado);?>";
			}
...
<script type="text/javascript">
  ...
  resizeIframeParent('<?php echo(CFG_SYSTEM_NAME); ?>_detailiframe_<?php echo(request("var_cod_conta_pagar_receber"));?>',20);
  window.parent.resizeIframeParent('<?php echo(CFG_SYSTEM_NAME); ?>_detailiframe_<?php echo(request("var_chavereg")); ?>',20);
  // ----------------------------------------------------------------------------------------------------------
</script>
</html>