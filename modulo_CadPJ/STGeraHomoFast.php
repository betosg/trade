<?php
	...
	try {
		$strSQL = "
				SELECT prd_produto.valor, prd_produto.descricao FROM prd_produto WHERE 
...
<tr>
	...
	<form name="formstatic" action="STGeraHomoFastexec.php" method="post">
		...
		<input type="hidden" name="var_redirect" value="STviewpfs.php?var_chavereg=<?php echo($intCodPJ);?>">
		<tr>
			...
			<td align="center" valign="top" style="padding:20px 50px 10px 50px;" width="1%">
				<table cellpadding="4" cellspacing="0" border="0" width="100%">
					...
					<tr bgcolor="<?php echo(CL_CORLINHA_1)?>">
						<td align="right" width="25%"><strong><?php echo(getTText("razao_social",C_NONE));?>:</strong></td>
					...
					<tr bgcolor="<?php echo(CL_CORLINHA_2)?>">
						...
						<td>&nbsp;<input type="text" name="var_dt_vcto" id="var_dt_vcto" value="<?php echo($dtVcto);?>" size="10" maxlength="10" onKeyUp="FormataInputData(this);" onKeyPress="javascript:return validateNumKey(event);" />
						</td>
					</tr>
					<tr bgcolor="<?php echo(CL_CORLINHA_2);?>">
					...
					<tr bgcolor="<?php echo(CL_CORLINHA_1)?>">
						<td align="right">
							<strong>*<?php echo(getTText("conta_banco",C_NONE));?>:</strong>
						</td>
					...
					<tr bgcolor="<?php echo(CL_CORLINHA_2)?>">
						<td align="right">
							<strong>*<?php echo(getTText("plano_de_conta",C_NONE));?>:</strong>
						</td>
					...
					<tr bgcolor="<?php echo(CL_CORLINHA_2)?>">
						...
						<td>&nbsp;<input name="var_historico" id="var_historico" value="<?php echo(getValue($objRSPed,"descricao")." (".$strNome.")");?>" size="60" />
						</td>
					</tr>
					<tr bgcolor="<?php echo(CL_CORLINHA_1)?>">
