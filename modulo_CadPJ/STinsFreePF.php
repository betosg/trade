			...
			<td align="center" valign="top">
				...
				<table style="border:0px; width:550px;" cellspacing="0" cellpadding="4"> 
                    ...
                    <tr bgcolor="#FFFFFF">  
                        ...
                        <td nowrap align="left" width="99%" ><span class="comment_med">ATENÇÃO: Inserção livre permite contatos sem CPF, se você possui<br />
                        o CPF recomenda-se a inser&ccedil;ão normal de Novo Colaborador com a <br />
                        validação prévia de CPF.</span></td>
                    </tr>

                    <tr bgcolor="#FAFAFA">
                        <td width="1%" align="right" valign="top" nowrap style="padding-right:5px;"><label for="var_nome"><strong>*Nome:</strong></label></td>
                        <td nowrap align="left" width="99%" ><input name="var_nome" id="var_nome" value="" type="text" size="50" maxlength="100" title="nome"><span class="comment_med">&nbsp;</span></td>
                    </tr>
                    <tr bgcolor="#FFFFFF">  
                    ...
                    <tr bgcolor="#FFFFFF"> 
                        ...
                        <td nowrap align="left" width="99%" ><input name="var_endprin_fone1" id="var_endprin_fone1" value="" type="text" size="27" maxlength="27"   title="Telefone 1"><span class="comment_med">&nbsp;</span></td>
                    </tr>
                    <tr bgcolor="#FAFAFA">
                    ...
                    <tr bgcolor="#FAFAFA">
                        <td width="1%" align="right" valign="top" nowrap style="padding-right:5px;"><label for="var_endprin_fone2"><strong>Telefone 3:</strong></label></td>
                    ...
                    <tr bgcolor="#FAFAFA">
                        <td width="1%" align="right" valign="top" nowrap style="padding-right:5px;"><label for="var_endprin_fone2"><strong>Telefone 4:</strong></label></td>
                    ...
                    <tr bgcolor="#FAFAFA">
                        <td width="1%" align="right" valign="top" nowrap style="padding-right:5px;"><label for="var_endprin_fone2"><strong>Telefone 5:</strong></label></td>
