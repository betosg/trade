...
try {
	$strSQL = "
	   SELECT t1.nome, t1.apelido, t1.data_nasc, t1.sexo, t1.email, t1.foto, t1.cpf, t1.rg, t1.tratamento
			, t1.email_extra, t1.website
			...
			, t1.endprin_cidade, t1.endprin_estado, t1.endprin_pais, t1.endprin_fone1, t1.endprin_fone2, t1.endprin_fone3, t1.endprin_fone4, t1.endprin_fone5
			, t1.endcom_cep, t1.endcom_logradouro, t1.endcom_numero, t1.endcom_complemento, t1.endcom_bairro
			, t1.endcom_cidade, t1.endcom_estado, t1.endcom_pais, t1.endcom_fone1, t1.endcom_fone2, t1.endcom_fone3, t1.endcom_fone4, t1.endcom_fone5
	...
	if ($objResult->rowCount() > 0) {
        ...
        $strTratamento    = getValue($objRS, "tratamento");
		...
		<tr> 
			<td align="center" valign="top">
				...
				<table style="border:0px; width:550px;" cellspacing="0" cellpadding="4"> 
                    ...
                    <tr bgcolor="#FAFAFA">
                        <td width="1%" align="right" valign="top" nowrap style="padding-right:5px;"><label for="var_nome"><strong>Cód:</strong></label></td>
                        <td nowrap align="left" width="99%" ><?php echo($strCodRelacPjPf); ?><span class="comment_med">&nbsp;</span></td>
                    </tr>
                    <tr bgcolor="#FAFAFA">
                        <td width="1%" align="right" valign="top" nowrap style="padding-right:5px;"><label for="var_nome"><strong>*Nome:</strong></label></td>
                        <td nowrap align="left" width="99%" ><?php echo($strNome); ?><span class="comment_med">&nbsp;</span></td>
                    </tr>
                    <tr bgcolor="#FFFFFF">  
                        <td width="1%" align="right" valign="top" nowrap style="padding-right:5px;"><label for="var_apelido"><strong>CPF:</strong></label></td>
                        <td nowrap align="left" width="99%"><?php echo($strCPF); ?>&nbsp;<br /><span class="comment_med">&nbsp;</span></td>
                    </tr>                   
                    <tr bgcolor="#FAFAFA">
                   ...
                   <!-- <tr bgcolor="#FAFAFA">  
                    ...
                    <tr bgcolor="#FFFFFF">
                        ...
                        <td nowrap align="left" width="99%"><?php echo $strFuncao;?></td>
                    </tr>
                    <?php } ?>
                    ...
                    <tr bgcolor="#FAFAFA">
                        ...
                        <td nowrap><?php echo($strDepartamento); ?></td>
                    </tr>
                    <?php } ?>
                   ...
                   <!-- <tr bgcolor="#FFFFFF">  
                    ...
                    <tr bgcolor="#FFFFFF">
                        ...
                        <td nowrap align="left" width="99%" ><?php echo($strEndPrinLogradouro); ?><span class="comment_med">&nbsp;</span></td>
                    </tr>
                    <tr bgcolor="#FAFAFA">  
                        ...
                        <td nowrap>
                            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                <tr>	
                                    <td nowrap align="left"><?php echo($strEndPrinNumero); ?><span class="comment_med">&nbsp;</span></td>
                                    ...
                                    <td nowrap align="left" width="99%" ><?php echo($strEndPrinComplemento); ?><span class="comment_med">&nbsp;</span></td>
                                </tr>
                            </table>									
                        </td>
                    </tr>
                    <tr bgcolor="#FFFFFF">
                        ...
                        <td nowrap align="left" width="99%"><?php echo($strEndPrinBairro); ?><span class="comment_med">&nbsp;</span></td>
                    </tr>
                    <tr bgcolor="#FAFAFA">  
                        ...
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                <tr>	
                                    <td nowrap align="left"><?php echo($strEndPrinCidade); ?><span class="comment_med">&nbsp;</span></td>
                                    ...
                                    <td nowrap align="left" width="99%" ><?php echo($strEndPrinEstado);?>
                    ...
                    <tr bgcolor="#FFFFFF"> 
                        ...
                        <td nowrap align="left" width="99%" ><?php echo($strEndPrinFone1); ?><span class="comment_med">&nbsp;</span></td>
                    </tr>
                    <tr bgcolor="#FAFAFA">
                        ...
                        <td nowrap align="left" width="99%"><?php echo($strEndPrinFone2); ?><span class="comment_med">&nbsp;</span></td>
                    </tr>
                    <tr bgcolor="#FAFAFA">
                        ...
                        <td nowrap align="left" width="99%"><?php echo($strEndPrinFone3); ?><span class="comment_med">&nbsp;</span></td>
                    </tr>
                    <tr bgcolor="#FAFAFA">
                        ...
                        <td nowrap align="left" width="99%"><?php echo($strEndPrinFone4); ?><span class="comment_med">&nbsp;</span></td>
                    </tr>
                    <tr bgcolor="#FAFAFA">
                        ...
                        <td nowrap align="left" width="99%"><?php echo($strEndPrinFone5); ?><span class="comment_med">&nbsp;</span></td>
                    </tr>
                   <!-- <tr><td colspan="2" height="5" bgcolor="#FFFFFF"></td></tr>
                    <tr>
                        <td></td>
						   ...
						   <td style="padding:10px 0px 10px 10px;">
								  <table border="0" cellpadding="0" cellspacing="0" width="100%">
									<tr>
										...
										<td align="left">ATENÇÃO! Você está prestes a remover o registro que está sendo visualizado. Para confirmar essa deleção clique no botão [ok], para desistir clique em [cancelar] </td>
									</tr>
								  </table>
						   </td>
