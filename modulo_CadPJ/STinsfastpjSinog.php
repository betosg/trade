...
<head>
	...
	<!--
		...
		function ajaxVerificaPJ(){
			...
			strSQL  = "SELECT cod_pj, razao_social FROM cad_pj WHERE cnpj = '"+ document.getElementById('dbvar_str_cnpj').value +"'"; 
...
<body bgcolor="#F5F5F5"  background="../img/bgFrame_<?php echo(CFG_SYSTEM_THEME); ?>_main.jpg">
	...
	<tr>
		...
		<?php athBeginFloatingBox("720","","<span style='font-weight:bold;'>".strtoupper(CFG_SYSTEM_NAME)." | ".ucwords(str_replace(CFG_SYSTEM_NAME."_","",getsession(CFG_SYSTEM_NAME."_dir_cliente")))." - (".getTText("cad_novo_filiado",C_NONE).")",CL_CORBAR_GLASS_1); ?>
			...
			<form name="formeditor_000" id="forminsert" action="STinsfastpjexecSinog.php" method="post" enctype="multipart/form-data">
				...
				<tr>
					<td align="center" valign="top" style="padding:0px 80px 0px 80px;"> 
						<table width="100%" cellpadding="3" cellspacing="0">
                            ...
                            <tr bgcolor="<?php getLineColor($strColor);?>">
                                <td align="right"><b>ABRAMGE:</b></td>
                                <td>
                                    <input name='dbvar_bool_vinculo_abramge' id='dbvar_bool_vinculo_abramge' type='radio' title='ABRAMGE' value='true' class='inputclean'>sim
                                    <input name='dbvar_bool_vinculo_abramge' id='dbvar_bool_vinculo_abramge' type='radio' title='ABRAMGE' value='false' checked class='inputclean'>não
                                    <span class='comment_med'>&nbsp;</span>&nbsp;
                                </td>
                            </tr>
                            
                            <tr bgcolor="<?php getLineColor($strColor);?>">
                                <td align="right"><b>SINOG:</b></td>
                                <td>
                                    <input name='dbvar_bool_vinculo_sinog' id='dbvar_bool_vinculo_sinog' type='radio' title='SINOG' value='true' class='inputclean'>sim
                                    <input name='dbvar_bool_vinculo_sinog' id='dbvar_bool_vinculo_sinog' type='radio' title='SINOG' value='false' checked class='inputclean'>não
                                    <span class='comment_med'>&nbsp;</span>&nbsp;
                                </td>
                            </tr>
                            
                            <tr bgcolor="<?php getLineColor($strColor);?>">
                                <td align="right"><b>SINAMGE:</b></td>
                                <td>
                                    <input name='dbvar_bool_vinculo_sinamge' id='dbvar_bool_vinculo_sinamge' type='radio' title='SINAMGE' value='true' class='inputclean'>sim
                                    <input name='dbvar_bool_vinculo_sinamge' id='dbvar_bool_vinculo_sinamge' type='radio' title='SINAMGE' value='false' checked class='inputclean'>não
                                    <span class='comment_med'>&nbsp;</span>&nbsp;
                                </td>
                            </tr>
                            
                            <tr bgcolor="<?php getLineColor($strColor);?>">
                                <td align="right"><b>UCA:</b></td>
                                <td>
                                    <input name='dbvar_bool_vinculo_uca' id='dbvar_bool_vinculo_uca' type='radio' title='UCA' value='true' class='inputclean'>sim
                                    <input name='dbvar_bool_vinculo_uca' id='dbvar_bool_vinculo_uca' type='radio' title='UCA' value='false' checked class='inputclean'>não
                                    <span class='comment_med'>&nbsp;</span>&nbsp;
                                </td>
                            </tr>
							...
							<tr bgcolor="<?php getLineColor($strColor);?>">
								...
								<td>
									<input type="text" name="dbvar_str_img_logo" id="dbvar_str_img_logo" size="40" readonly>
							...
							<tr bgcolor="<?php getLineColor($strColor);?>">
								...
								<td>
									<input type="text" name="dbvar_str_arquivo_1" id="dbvar_str_arquivo_1" size="40" readonly>
							...
							<tr bgcolor="<?php getLineColor($strColor);?>">
								...
								<td>
									<input type="text" name="dbvar_str_arquivo_2" id="dbvar_str_arquivo_2" size="40" readonly>
							...
							<tr bgcolor="<?php getLineColor($strColor);?>">
								...
								<td>
									<input type="text" name="dbvar_str_arquivo_3" id="dbvar_str_arquivo_3" size="40" readonly>
