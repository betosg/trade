		  ...
		  <td align="center" valign="top">
			<table width="550" border="0" cellspacing="0" cellpadding="4">
							...
							<tr bgcolor="<?php echo($strBGColor2)?>">
								...
								<!-- 
								<select name="var_cod_produto" id="var_cod_produto" style="width:360px" size="1" title="Produto"  onChange="BuscaProdDefaults(this);">
								//-->

								<!--
                                	Neste popnto poderia criar uma nova função AJAX para trazer todoso os dados de uma vez só,
                                    mas como o cliente não tem muiuta certeza do que quer, optei por usar a função genérica [ajaxDetailData]
                                    que consegue buscar UM dado por vez, e chamá-la várias vezes.
                                //-->
                                <select name="var_cod_produto" id="var_cod_produto" style="width:360px" size="1" title="Produto" 
                                 onChange="
							...
							<tr bgcolor="<?php echo($strBGColor1)?>">
								...
								<td>
								<select name="var_cod_plano_conta" id="var_cod_plano_conta" size="1" style="width:320px;">
						  ...
						  <?php if($usarIndice == "usar_indice"){ ?>
							...
							<tr bgcolor="<?php echo($strBGColor1)?>">
								...
								<td>
									<select name="var_tipo_documento" id="var_tipo_documento"class="edtext"  style="width:200px;">
										<option value="" selected="selected"></option>
