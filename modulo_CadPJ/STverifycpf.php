...
<head>
	...
	<script type="text/javascript" language="javascript">
		...
		function cancelar() {
			location.href = "../modulo_CadPJ/STviewpfs.php?var_chavereg=<?php echo($intCodPJ);?>";
		}
	</script>
</head>
<body bgcolor="#FFFFFF">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%" align="center">
	<tr>
	<form name="formverifica" action="STverifycpfexec.php" method="post">
		<input type="hidden" name="var_chavereg" id="var_chavereg" value="<?php echo($intCodPJ); ?>" />
		<input type="hidden" name="var_flag_inserir" value="<?php echo($flagInsert);?>" />
			...
			<tr> 
		  		<td align="center" valign="top">
					<table width="550" border="0" cellspacing="0" cellpadding="4">
						...
						<tr bgcolor="#FAFAFA">
							<td width="25%" align="right" valign="top" nowrap style="padding-left:35px;"><strong>*CPF:</strong></td>
							<td width="75%" nowrap align="left">
								<input name="var_cpf" id="var_cpf" value="" type="text" size="30" maxlength="11" title="CPF" tabindex="1" onKeyPress="javascript:return validateNumKey(event);">
								<br /><span class="comment_med">(Somente Números, sem Pontos e/ou Traços)</span>
							</td>
						</tr>
