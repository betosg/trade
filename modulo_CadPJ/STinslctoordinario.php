...
<html>
	<head>
		...
		<!--
			...
			function ok() {
				strLocation = "../modulo_CadPJ/STifrlancamento.php?var_cod_resize=<?php echo(request("var_cod_resize"))?>&var_chavereg=<?php echo($intCodTitulo);?>";
				submeterForm();
			}

			function cancelar() {
				location.href = "../modulo_CadPJ/STifrlancamento.php?var_cod_resize=<?php echo(request("var_cod_resize"))?>&var_chavereg=<?php echo($intCodTitulo);?>";
			}

			function aplicar() {
				strLocation = "../modulo_CadPJ/STinslctoordinario.php?var_chavereg=<?php echo($intCodTitulo)?>&var_cod_pj=<?php echo(request("var_cod_pj"))?>";
				submeterForm();
			}
