...
<html>
	<head>
		...
		<!--
			...
			function ok() {
				strLocation = "../modulo_CadPJ/STifrlancamentoABFM.php?var_cod_resize=<?php echo(request("var_cod_resize"))?>&var_chavereg=<?php echo($intCodTitulo);?>";
				submeterForm();
			}

			function cancelar() {
				location.href = "../modulo_CadPJ/STifrlancamentoABFM.php?var_cod_resize=<?php echo(request("var_cod_resize"))?>&var_chavereg=<?php echo($intCodTitulo);?>";
			}

			function aplicar() {
				strLocation = "../modulo_CadPJ/STinslctoordinarioABFM.php?var_chavereg=<?php echo($intCodTitulo)?>&var_cod_pj=<?php echo(request("var_cod_pj"))?>";
				submeterForm();
			}
				...
				<tr>
					<td align="center" valign="top">
						<table width="500" border="0" cellspacing="0" cellpadding="4">
                            ...
                            <tr> 
								<td align="right" valign="middle">*<b>Data Crédito:</b>&nbsp;</td>
