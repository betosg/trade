...
try{
	...
	echo	$strSQL = "	SELECT out_cod_pj, out_razao_social, out_matricula, out_endprin_cep, out_endprin_logradouro
   ...
   for ($x = 0; $x <= count($strEmail)-1; $x++) {
	//echo $x.": ".$strEmail[$x]." <br>";
		if ($strEmail[$x] !=""){
				...
				emailNotify($strMailCorpo, $strCartaCobrancaEmailAssunto, "gabriel@proevento.com.br", CFG_EMAIL_SENDER,""          , $strCartaCobrancaRemetente, $strCartaCobrancaRemetente);
