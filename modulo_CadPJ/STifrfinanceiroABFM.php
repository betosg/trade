			...
			athBeginCssMenu();
				...
				athBeginCssSubMenu();	
					athCssMenuAddItem("","_self",getTText("abertos",C_UCWORDS),1);
						athBeginCssSubMenu();
							athCssMenuAddItem("STifrfinanceiroABFM.php?var_chavereg=".$intVlrCampoChaveDetail."&var_field_detail=".$strNomeCampoChaveDetail."&var_situacao=aberto"      ,"_self",getTText("abertos",C_UCWORDS));
							athCssMenuAddItem("STifrfinanceiroABFM.php?var_chavereg=".$intVlrCampoChaveDetail."&var_field_detail=".$strNomeCampoChaveDetail."&var_situacao=vencidos"      ,"_self",getTText("vencidos",C_UCWORDS));
							athCssMenuAddItem("STifrfinanceiroABFM.php?var_chavereg=".$intVlrCampoChaveDetail."&var_field_detail=".$strNomeCampoChaveDetail."&var_situacao=a_vencer"      ,"_self",getTText("a_vencer",C_UCWORDS));
						athEndCssSubMenu();
					athCssMenuAddItem("STifrfinanceiroABFM.php?var_chavereg=".$intVlrCampoChaveDetail."&var_field_detail=".$strNomeCampoChaveDetail."&var_situacao=lcto_parcial","_self",getTText("parciais",C_UCWORDS));
					athCssMenuAddItem("STifrfinanceiroABFM.php?var_chavereg=".$intVlrCampoChaveDetail."&var_field_detail=".$strNomeCampoChaveDetail."&var_situacao=agrupado"    ,"_self",getTText("agrupados",C_UCWORDS));
					athCssMenuAddItem("STifrfinanceiroABFM.php?var_chavereg=".$intVlrCampoChaveDetail."&var_field_detail=".$strNomeCampoChaveDetail."&var_situacao=lcto_total"  ,"_self",getTText("pagos",C_UCWORDS));
					athCssMenuAddItem("STifrfinanceiroABFM.php?var_chavereg=".$intVlrCampoChaveDetail."&var_field_detail=".$strNomeCampoChaveDetail."&var_situacao=cancelado"   ,"_self",getTText("cancelados",C_UCWORDS));
					athCssMenuAddItem("STifrfinanceiroABFM.php?var_chavereg=".$intVlrCampoChaveDetail."&var_field_detail=".$strNomeCampoChaveDetail."&var_situacao=%"           ,"_self",getTText("todos",C_UCWORDS));
				athEndCssSubMenu();
			athEndCssMenu();		
		?>
		</td>
	...
	<table bgcolor="#CFCFCF" style="width:auto;border-right:1px solid #E9E9E9;" class="tablesort">
		...
		<?php
			...
			<tr bgcolor="<?php echo(getLineColor($strColor));?>">
				...
				<td align="center">
					<img src="../img/icon_ver_lancamento.gif" title="Ver Lançamentos" onClick="showDetailGridT('<?php echo(getValue($objRS,"cod_conta_pagar_receber"));?>','../modulo_CadPJ/STifrlancamentoABFM.php?var_cod_resize=<?php echo(request("var_chavereg"));?>','cod_conta_pagar_receber');" border="0" style="cursor:pointer;">
				</td>
				<td align="center">
