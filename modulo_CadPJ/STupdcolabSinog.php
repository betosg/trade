  ...
  <td align="center" valign="top">
	<?php athBeginFloatingBox("630","none","COLABORADOR (" . $strRotulo . ")",CL_CORBAR_GLASS_1); ?>
		<table width="100%" bgcolor="#FFFFFF" style="border:1px #A6A6A6 solid;">
	   		<form name="formeditor" action="STupdcolabexecSinog.php" method="post" id="formeditor">
			...
			<td align="center" valign="top">
				...
				<table style="border:0px; width:550px;" cellspacing="0" cellpadding="4"> 
                    ...
                    <tr bgcolor="#FAFAFA">
                        ...
                        <td nowrap align="left" width="99%" ><input name="var_nome" id="var_nomeô" value="<?php echo($strNome); ?>" type="text" size="50" maxlength="100" title="nome"><span class="comment_med">&nbsp;</span></td>
                    </tr>
                    <tr bgcolor="#FFFFFF">  
                    ...
                    <tr bgcolor="#FAFAFA">
                        ...
                        <td nowrap align="left" width="99%"><input name="var_tratamento" id="var_tratamento" value="<?php echo($strTratamento); ?>" type="text" size="27" maxlength="27"   title="tratamento"><span class="comment_med">&nbsp;</span></td>
                    </tr>

                    <tr bgcolor="#FFFFFF">  
                        <td width="1%" align="right" valign="top" nowrap style="padding-right:5px;"><label for="var_cpf"><strong>CPF:</strong></label></td>
                        <td nowrap align="left" width="99%" ><input name="var_cpf" id="var_cpf" value="<?php echo($intCPF); ?>" onKeypress="javascript:validateNumKey(event);"type="text" size="50" maxlength="11" title="nome"><span class="comment_med">&nbsp;</span></td>
                    </tr>

                    <tr bgcolor="#FFFFFF">  
                        <td width="1%" align="right" valign="top" nowrap style="padding-right:5px;"><label for="var_rg"><strong>RG:</strong></label></td>
                        <td nowrap align="left" width="99%" ><input name="var_rg" id="var_rg" value="<?php echo($intRG); ?>" onKeypress="javascript:validateNumKey(event);" type="text" size="50" maxlength="30" title="nome"><span class="comment_med">&nbsp;</span></td>
                    </tr>
                    <tr bgcolor="#FAFAFA">  
                   ...
                   <!-- <tr bgcolor="#FFFFFF">  
                    ...
                    <tr bgcolor="#FFFFFF"> 
                        ...
                        <td nowrap align="left" width="99%" ><input name="var_endprin_fone1" id="var_endprin_fone1ô" value="<?php echo($strEndPrinFone1); ?>" type="text" size="27" maxlength="27"   title="Telefone 1"><span class="comment_med">&nbsp;</span></td>
                    </tr>
                    <tr bgcolor="#FAFAFA">
                    ...
                    <tr bgcolor="#FAFAFA">
                        ...
                        <td nowrap align="left" width="99%"><input name="var_endprin_fone3" id="var_endprin_fone3" value="<?php echo($strEndPrinFone3); ?>" type="text" size="27" maxlength="27"   title="Telefone 2"><span class="comment_med">&nbsp;</span></td>
                    </tr>
                    <tr bgcolor="#FAFAFA">
                        ...
                        <td nowrap align="left" width="99%"><input name="var_endprin_fone4" id="var_endprin_fone4" value="<?php echo($strEndPrinFone4); ?>" type="text" size="27" maxlength="27"   title="Telefone 2"><span class="comment_med">&nbsp;</span></td>
                    </tr>
                    <tr bgcolor="#FAFAFA">
                        ...
                        <td nowrap align="left" width="99%"><input name="var_endprin_fone5" id="var_endprin_fone5" value="<?php echo($strEndPrinFone5); ?>" type="text" size="27" maxlength="27"   title="Telefone 2"><span class="comment_med">&nbsp;</span></td>
                    </tr>
                   <!-- <tr><td colspan="2" height="5" bgcolor="#FFFFFF"></td></tr>
                    <tr>
                        <td></td>
