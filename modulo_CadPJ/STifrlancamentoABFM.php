	 	...
	 	<script language="javascript">
			...
			function removeLancamento(prCodLancamento){
				if(confirm("Tem certeza que deseja remover este lançamento?")){
					window.location = 'STremovelancamento.php?var_chavereg=' + <?php echo($intCodTitulo); ?> + '&var_cod_lcto_ordinario=' + prCodLancamento + '&var_cod_resize=<?php echo(request("var_cod_resize"));?>';
				}
			}
		</script>
	</head>
			...
			<td align="left">
				<?php
					...
					athBeginCssMenu();
						...
						athBeginCssSubMenu();
							athCssMenuAddItem("STinslctoordinarioABFM.php?var_chavereg=".$intCodTitulo."&var_cod_resize=".$intCodResize,
	...
	<table align="center" cellpadding="0" cellspacing="1" style="width:100%" class="tablesort">
		...
		?>
			<tr bgcolor="<?php echo(getLineColor($strColor)); ?>">	
				...
				<td style="vertical-align:middle;" align="center">
					<?php echo(dDate(CFG_LANG,getValue($objRS,"dt_cred"),false));?>
				</td>
