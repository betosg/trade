...
function submeterForm(prAcao){
	document.formconf.DEFAULT_LOCATION.value = (prAcao == "ok") ? "<?php if (strpos(getsession($strSesPfx . "_grid_default"),"?") === false) echo("../_fontes/".getsession($strSesPfx . "_grid_default")."?var_basename=".getsession($strSesPfx . "_dir_modulo")); else echo("../_fontes/".getsession($strSesPfx . "_grid_default")."&var_basename=".getsession($strSesPfx . "_dir_modulo")); ?>" : "../modulo_FinConta/STinslctotransf.php?var_cod_conta=" + document.formconf.dbvar_num_cod_conta_origô_000.value;
				...
				<td align="center" valign="top">
					<table width="550" border="0" cellspacing="0" cellpadding="4">
						...
						<tr bgcolor="#FAFAFA"> 
							...
							<td valign="middle"> 
								<select name="dbvar_num_cod_conta_origô" id="dbvar_num_cod_conta_origô_000" class="edtext" style="width:230px;" onChange="ajaxDetailData('SELECT cod_conta, nome FROM fin_conta WHERE dtt_inativo IS NULL AND cod_conta <> '+this.value+' ORDER BY nome', 'ajaxMontaCombo', 'dbvar_num_cod_conta_destô_000', '');">
									<option selected="selected"><?php echo(getTText("selecione",C_UCWORDS)); ?>...</option>
						...
						<tr> 
							...
							<td valign="middle"> 
								<select name="dbvar_num_cod_conta_destô" id="dbvar_num_cod_conta_destô_000" class="edtext" style="width:230px;">
									<option selected="selected"><?php echo(getTText("selecione",C_UCWORDS)); ?>...</option>
									<?php echo(montaCombo($objConn," SELECT cod_conta, nome FROM fin_conta WHERE dtt_inativo IS NULL ORDER BY nome ","cod_conta","nome","")); ?>
								</select>
							</td>
					    ...
					    <tr bgcolor="#FAFAFA"> 
							...
							<td valign="middle"><input name="dbvar_str_num_lctoô" id="dbvar_str_num_lctoô_000" class="edtext" type="text" style="width:125px;" maxlength="50"></td>
						</tr>
						<tr> 
							<td align="right" valign="middle">*<b><?php echo(getTText("valor",C_UCWORDS)); ?>:</b>&nbsp;</td>
							<td valign="middle"><input name="dbvar_moeda_vlr_lctoô" id="dbvar_moeda_vlr_lctoô_000" class="edtext" type="text" style="width:105px;" maxlength="15" onKeyPress="return(validateFloatKeyNew(this,event));"></td>
						</tr>
						<tr bgcolor="#FAFAFA"> 
						...
						<tr>
							<td align="right" colspan="3" style="padding:10px 0px 10px 10px;">
								<button class="inputcleanActionOk" onClick="submeterForm('ok');"><?php echo(getTText("ok",C_UCWORDS)); ?></button>
