...
<html>
	<head>
		...
		<script language="javascript" type="text/javascript">
			...
			function cancelar() {
				window.location = "../miniapp_cadPfAtuacao/index.php?var_chavereg=<?php echo $intcodigo;?>";
			}
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	<form name="formstatic" action="STinsAtuacaoExec.php" method="POST" />
