...
<?php
	...
	$strCodAtuacao   = request("var_cod_atuacao");
...
/**	try{
		...
		$strSQL = "	select t1.cod_pf_atuacao as codigo, t2.nome
				from cad_pf_atuacao t1
				inner join cad_atuacao t2 on t2.cod_atuacao = t1.cod_atuacao
...
<html>
	<head>
		...
		<script language="javascript" type="text/javascript">
			...
			function cancelar() {
				window.location = "../miniapp_cadPfAtuacao/index.php?var_chavereg=<?php echo $var_cod_cad;?>";
			}
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	<form name="formstatic" action="STupdAtuacaoExec.php" method="POST" />
				...
				<table cellspacing="2" cellpadding="3" border="0" width="100%">
					...
					<tr bgcolor="<?php echo(getLineColor($strColor));?>">
						...
						<td width="73%" align="left">
							<?php echo $intcodigo;?>
							<input type="hidden" name="dbvar_cod_atuacao" id="dbvar_cod_atuacao" value="<?php echo($intcodigo)?>"style="width:200px;" maxlength="99" />							
							<input type="hidden" name="codigo_pai" id="codigo_pai" style="width:200px;" maxlength="99" value="<?php echo($var_cod_cad);?>"/>							
					</tr>
					
					<tr bgcolor="<?php echo(getLineColor($strColor));?>">
						<td width="27%" align="right"><strong>Área</strong></td>
						<td width="73%" align="left">
							<select id="DBVAR_STR_ATUACAO" name="DBVAR_STR_ATUACAO">
								<option value="">Selecione...</option>
							<?php  
								$strSQL = "select cod_atuacao,nome
								from cad_atuacao";
								echo (montaCombo($objConn  , $strSQL, "cod_atuacao", "nome"  , $strCodAtuacao, ""));
			...
			<td colspan="3" style="padding:10px 50px 0px 50px;">
				<table cellspacing="0" cellpadding="0" border="0" width="100%">
					<tr>
						...
						<td width="10%" align="left">
							<button class="inputcleanActionCancelar" class="inputcleanActionCancelar" onClick="cancelar();return false;">cancelar</button>
						</td>
						<td width="10%" align="left">
