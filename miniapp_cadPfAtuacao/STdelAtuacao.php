...
<?php
	...
	try{
		...
		$strSQL = "	select t1.cod_pf_atuacao as codigo, t2.nome,t2.cod_atuacao
				...
				where t1.cod_pf = " . $var_cod_cad . "
				and cod_pf_atuacao = " . $intcodigo. "
				order by t2.nome";
...
<html>
	<head>
		...
		<script language="javascript" type="text/javascript">
			...
			function ok() {
				strLocation = "../miniapp_cadPfAtuacao/index.php?var_chavereg=<?php echo $var_cod_cad;?>";
				submeterForm();
			}
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	<input type="hidden" name="DEFAULT_TABLE" 			value="cad_pf_atuacao" />
	<input type="hidden" name="DEFAULT_DB" 				value="<?php echo(CFG_DB);?>" />
	<input type="hidden" name="FIELD_PREFIX" 			value="DBVAR_" />
	<input type="hidden" name="RECORD_KEY_NAME" 		value="cod_pf_atuacao" />
			...
			<td align="left" valign="top" style="padding:10px 50px 0px 50px;">
				<table cellspacing="2" cellpadding="3" border="0" width="100%">
					...
					<tr bgcolor="<?php echo(getLineColor($strColor));?>">
						...
						<td width="73%" align="left"> <?php echo(getValue($objRS,"nome"));?>
						</td>
					</tr>
				...
				<table cellspacing="0" cellpadding="0" border="0" width="100%">
					<tr>
						...
						<td width="20%" align="left">
							<button class="inputcleanActionOk" onClick="ok();">
								ok
							</button>
						</td>
