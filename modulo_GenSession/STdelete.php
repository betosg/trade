...
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
 <tr>
   <td align="center" valign="top">
	<?php athBeginFloatingBox("725","none","CONFIG (Deleção)",CL_CORBAR_GLASS_1); ?>
    <table id="dialog" width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:1px solid #A6A6A6;">
	    <form name="formstatic" action="STsessionexec.php" method="post">
			...
			<input type="hidden" name="var_valor" value="">
			<input type="hidden" name="var_delete" value="sim">
		...
		<tr> 
			<td align="center" valign="top">
				<table width="550" border="0" cellspacing="0" cellpadding="4">
					<tr bgcolor="#FFFFFF">
						<td width="1%" align="right"><strong>*Índice:</strong>&nbsp;</td>
						<td><?php echo($strIndice); ?></td>
					</tr>
					<tr bgcolor="#FAFAFA">
						<td width="1%" align="right" valign="top"><strong>*Valor:</strong>&nbsp;</td>
						<td><?php echo(getsession($strIndice)); ?></td>
					</tr>
					<tr align="left">
									...
									<td style="padding:10px 0px 10px 10px;">
										  <table border="0" cellpadding="0" cellspacing="0" width="100%">
											<tr>
												...
												<td>
													ATENÇÃO! Você está prestes a remover o registro que está sendo visualizado. 
													Para confirmar essa deleção clique no botão [ok], para desistir clique em [cancelar] 
												</td>
											</tr>
										  </table>
									</td>
