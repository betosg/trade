...
$strIndice    = request("var_chavereg");   // Código chave da página
...
if(isset($_SESSION[$strIndice])) { 
	$strValor = getsession($strIndice); //Aplica o filtro no array do arquivo
?>
<html>
<head>
...
function aplicar() {
	strLocation = "STupdate.php?var_chavereg=<?php echo($strIndice); ?>";
	submeterForm();
}
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
 <tr>
   <td align="center" valign="top">
	<?php athBeginFloatingBox("725","none",getTText("gensession",C_NONE) . " (Atualização)",CL_CORBAR_GLASS_1); ?>
				...
				<table width="550" border="0" cellspacing="0" cellpadding="4">
					<tr bgcolor="#FFFFFF">
						...
						<td>
							...
							<span class="comment_med"><?php echo(getTText("indice_desc_upd1",C_NONE) . "<strong>" . CFG_SYSTEM_NAME . "</strong>" . getTText("indice_desc_upd2",C_NONE)); ?></span>
						</td>
					</tr>
					<tr bgcolor="#FAFAFA">
						<td width="1%" align="right" valign="top"><strong>*<?php echo(getTText("valor",C_NONE)); ?>:</strong>&nbsp;</td>
						<td>
							<textarea name="var_valor" cols="60" rows="6"><?php echo($strValor); ?></textarea>
						</td>
					</tr>
					<tr align="left">
