...
function verifica(){
	...
	//if ((document.formeditor.var_opcao_a.checked) && (document.formeditor.var_cod_pf.value == "")) var_msg += "\nInformar código do associado";
	...
	if (var_msg == ""){
		...
		document.formeditor.action = 'STGeraPedidoexecPF.php';		
...
function abreJanelaPageLocal(pr_link, pr_extra){
	...
	document.getElementById("var_opcao_a").checked = true;
}
		  ...
		  <td align="center" valign="top">
			<table width="550" border="0" cellspacing="0" cellpadding="4">
							...
							<tr bgcolor="<?php echo($strBGColor1)?>">
								...
								<tr>
									<td width="1%" valign="top"><input type="radio" value="um_associado" name="var_opcao" id="var_opcao_a" style="border-style:none;" onClick="AlteraOpcoesGerar();" <?php if ($strOpcao == "A") echo("checked='checked'"); ?>></td>
									<td width="99%">um associado de código <input name="var_cod_pf" id="var_cod_pf" value="<?php echo($intCodPF); ?>" type="text" size="6" maxlength="10" title="Empresa">
									<a href="javascript:abreJanelaPageLocal('../modulo_CadPF/?var_acao=single&var_fieldname=var_cod_pf&var_formname=formeditor','');"><img src="../img/icon_search.gif" border="0" hspace="5" align="absmiddle"></a></td>
								</tr>
								...
								<!--tr>
									...
									<td width="99%">todas as pessoas que são
							...
							<tr bgcolor="<?php echo($strBGColor2)?>">
								...
								?>
								</select><span class="comment_med"><?php //print($strSQL)?>&nbsp;</span>
								</td>
							</tr>
							<tr bgcolor="<?php echo($strBGColor1)?>">
							...
							<?php if($usarIndice == "usar_indice"){ ?>
							<tr bgcolor="<?php echo($strBGColor2)?>">
								<td align="right" style="vertical-align:top"><label for="var_tipo_indice"><strong>Tipo Índice:</strong></label></td>
								<td>
									<select name="var_tipo_indice" id="var_tipo_indice" size="1" style="width:160px;">
										<option value="" selected="selected"></option>
										<?php echo(montaCombo($objConn, " SELECT DISTINCT tipo FROM fin_indice ORDER BY tipo ", "tipo", "tipo", "", "")); ?>
									</select>
									<br><span class="comment_peq">Deixar em branco caso não seja utilizado nenhum tipo de indice</span>
								</td>
							</tr>		
							<?php }?>
							<tr bgcolor="<?php echo($strBGColor2)?>">
