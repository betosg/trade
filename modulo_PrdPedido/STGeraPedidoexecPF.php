...
if(($strOpcao == "um_associado") && ($intCodPF == "")) $strMsg .= "Informar associado<br>";
...
try{
	if ($strOpcao == "um_associado") {
	 $strSQL = " SELECT * FROM sp_gera_pedido_pf('".$strGerar."', ".$intCodPF.", NULL, ".$intCodProduto.", '".$dtVcto."', ".$dblValor.", ".$intCodConta.", ".$intCodPlanoConta.", ".$intCodCentroCusto.", ".$intCodJob.", ".$intCodCFGBoleto.", '".$strTipoDocumento."', '".$strHistorico."', '".$strObsPedido."', '".$strObsTitulo."', ".$intParcelas.", '".$strFrequencia."', '".getsession(CFG_SYSTEM_NAME."_id_usuario")."') ";
	//die();
	}else {
