...
HTMLArea.Config = function () {
	...
	this.toolbar = [
		[ "fontname", "space",
		  "fontsize", "space",
		  "formatblock", "space",
		  "bold", "italic", "underline", "strikethrough", "separator", "subscript", "superscript", "killword" ],
		  
		[ "copy", "cut", "paste", "space", "undo", "redo", "space",
		  "justifyleft", "justifycenter", "justifyright", "justifyfull", "lefttoright", "righttoleft", "separator", "orderedlist", "unorderedlist"],
		  
		[ "outdent", "indent", "forecolor", "hilitecolor","inserthorizontalrule", "createlink", "insertimage", "inserttable", "htmlmode" ],
