<?php
	...
	try{
		...
		$strSQLAdiant .= (isset($strTipoUsuario) && $strTipoUsuario == "todos") ? " AND (id_responsavel = '".getsession(CFG_SYSTEM_NAME."_id_usuario")."' OR id_ult_executor = '".getsession(CFG_SYSTEM_NAME."_id_usuario")."')" : "";
