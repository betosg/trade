...
<html>
 <head>
  ...
  <frameset  cols="250,*" frameborder="no" id="<?php echo(CFG_SYSTEM_NAME . "_principal"); ?>" name="<?php echo(CFG_SYSTEM_NAME . "_principal"); ?>" border="0" framespacing="0" rows="*"> 
	<frame name="<?php echo(CFG_SYSTEM_NAME . "_left"); ?>" id="<?php echo(CFG_SYSTEM_NAME . "_left"); ?>" src="STmenu.php?var_redirect=<?php echo $strURLRedirect; ?>" scrolling="no" onResize="document.getElementById('<?php echo(CFG_SYSTEM_NAME . "_principal"); ?>').cols = this.width + ',*';">
