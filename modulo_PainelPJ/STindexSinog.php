	...
	<td width="99%" style="vertical-align:top">
		...
		<tr>
			...
			<table width="90%" align="center">
						<tr>
							...
							?>	
								<td style="text-align:left; vertical-align:top;" style="cursor:pointer;"><img src="../img/LogoMarca_ABRAMGE.png" onClick="submitForm('abramge');" style="cursor:pointer;" vspace="5" border="0"></td>
							<?php }
							if (getsession(CFG_SYSTEM_NAME."_dir_cliente") != "sinamge"){
							?>
								<td style="text-align:left; vertical-align:top;" style="cursor:pointer;"><img src="../img/LogoMarca_SINAMGE.png" onClick="submitForm('sinamge');" style="cursor:pointer;" vspace="5" border="0"></td>
							<?php }
		...
		<script language="javascript">
			...
			function submitForm(prAction){
				...
				setCookie("cookie_ambiente", "<?php echo(getsession(CFG_SYSTEM_NAME."_passwd"));?>");
				...
				<tr>
					...
					<div style="margin:10px 10px 0px 0px; background-color:transparent;">
						...
						<iframe name="<?php echo(CFG_SYSTEM_NAME);?>_detailiframe_titulos" 
                                ...
                                width="100%" 
                                height="90%" 
                                src="STincludetitulosSinog.php?var_cachereg=<?php echo($strAntiCache);?>"
                                frameborder="0" 
                                scrolling="yes"
		                        style="display:inline-table;">
						</iframe>
