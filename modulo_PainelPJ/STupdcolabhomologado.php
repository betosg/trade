	...
	try {
		$strSQL = "
			SELECT 
				...
				, t2.arquivo_2
				, t2.arquivo_3
				, t1.rg, t1.cnh, t1.pis, t1.ctps, t1.cpf, t1.titulo_eleitoral
...
<head>
	...
	<!--
		...
		function cancelar(){
			window.location= "../modulo_PainelPJ/STColab.php";
		}
 	...
 	<tr>
		...
		<?php athBeginFloatingBox("720","none","COLABORADOR (" . $strRotulo . ")",CL_CORBAR_GLASS_1); ?>
			<table border="0" width="700" bgcolor="#FFFFFF" style="border:1px #A6A6A6 solid;" cellspacing="0" cellpadding="4">
	   		<form name="formeditor" action="STinsColab<?php echo $strModo; ?>_Passo2exec.php" method="post">
				...
				<input type="hidden" name="DEFAULT_LOCATION" value="../modulo_PainelPJ/STColab.php" />
				<!-- 
