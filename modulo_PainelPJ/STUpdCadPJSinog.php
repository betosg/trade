		...
		<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
	  	<!-- <tr><td valign="top" height="35%"><img src="../img/system_logo.gif" border="0" hspace="10" vspace="10"><td></tr> -->
	  		<tr>
				...
				<?php athBeginFloatingBox("600","","ALTERAÇÃO DE DADOS FILIADO - EMPRESA ( Alteração )",CL_CORBAR_GLASS_1); ?>
						 	...
						 	<td align="center" valign="top"> 
								<table width="500" cellpadding="3" cellspacing="0">
									...
									<tr bgcolor="#FAFAFA">
										...
										<td>
											<div style="padding-left:10px">
											<input type="hidden" id="dbvar_str_razao_social" name="dbvar_str_razao_social" value="<?php echo getValue($objRS,"razao_social");?>" >
									...
									<tr bgcolor="#FFFFFF">
										...
										<td>
											<div style="padding-left:10px">
											<input type="hidden" id="dbvar_str_nome_fantasia" name="dbvar_str_nome_fantasia" value="<?php echo getValue($objRS,"nome_fantasia");?>" >
									...
									<tr bgcolor="#FAFAFA">
										...
										<td>
											<div style="padding-left:10px">
												<input type="text" name="dbvar_num_capital" id="dbvar_num_capital" size="40" value="<?php echo FloatToMoeda(getValue($objRS,"capital")); ?>"  onKeyPress="return(validateFloatKeyNew(this,event));">
											</div>
										</td>
									</tr>
                                    <tr bgcolor="#FAFAFA">
										...
										<td>
											<div style="padding-left:10px">
												<input type="text" name="dbvar_str_email" id="dbvar_str_email" size="40" value="<?php echo getValue($objRS,"email"); ?>"  onBlur="verifyEmail(this,this.value)">
											</div>
										</td>
									</tr>
									<tr bgcolor="#FFFFFF">
										...
										<td>
											<div style="padding-left:10px">
												<input type="text" name="dbvar_str_email_2" id="dbvar_str_email_2" size="40" value="<?php echo getValue($objRS,"email_extra"); ?>">
											</div>
										</td>
									</tr>
									<tr bgcolor="#FAFAFA">
										...
										<td>
											<div style="padding-left:10px">
												<input type="text" name="dbvar_str_website" id="dbvar_str_website" size="40" value="<?php echo getValue($objRS,"website"); ?>">
											</div>
										</td>
									</tr>
									<tr>
										...
										<td>
											<div style="padding-left:8px">
												<table align="left">
													<tr>
														<td>
															<input type="text" name="dbvar_str_cep" id="dbvar_str_cep" size="10" maxlength="8" value="<?php echo getValue($objRS,"endprin_cep"); ?>" onKeyPress="return validateNumKey(event)">
														</td>
														<td>
										...
										<td>
											<div style="padding-left:8px">
												<table align="left">
													<tr>
														<td>
															<input type="text" name="dbvar_str_logradouro" id="dbvar_str_logradouro" size="45" value="<?php echo getValue($objRS,"endprin_logradouro"); ?>">
														</td>
														<td>
										...
										<td>
											<div style="padding-left:8px">
												<table>
													<tr>
														<td>
															<input type="text" name="dbvar_str_numero" id="dbvar_str_numero" size="5" maxlength="6" value="<?php echo getValue($objRS,"endprin_numero"); ?>">
														</td>
														<td>
															<div style="padding-left:8px">
																<input type="text" name="dbvar_str_complemento" id="dbvar_str_complemento" size="10" maxlength="" value="<?php echo getValue($objRS,"endprin_complemento"); ?>">
															</div>
														</td>
													</tr>
												</table>
									...
									<tr>
										...
										<td>
											<div style="padding-left:10px">
												<input type="text" name="dbvar_str_bairro" id="dbvar_str_bairro" size="25" value="<?php echo getValue($objRS,"endprin_bairro"); ?>">
											</div>
										</td>
									</tr>
									<tr bgcolor="FAFAFA">
										...
										<td>
											<div style="padding-left:8px">
												<table align="left">
													<tr>
														<td>
															<input type="text" name="dbvar_str_cidade" id="dbvar_str_cidade" size="30" value="<?php echo getValue($objRS,"endprin_cidade"); ?>">
														</td>
														...
														<td>
															<div style="padding-left:5px;">
																<select name="dbvar_str_uf" id="dbvar_str_uf" style="width: 45px;">
																	<?php echo(montaCombo($objConn,"SELECT sigla_estado FROM lc_estado ORDER BY sigla_estado","sigla_estado","sigla_estado",getValue($objRS,"endprin_estado"))); ?>
											 					</select>
															</div>
														</td>
									...
									<tr>
										...
										<td>
											<div style="padding-left:10px">
												<input type="text" name="dbvar_str_telefone" id="dbvar_str_telefone" size="20" maxlength="50" value="<?php echo getValue($objRS,"endprin_fone1"); ?>">
											</div>
										</td>
									</tr>
									<tr bgcolor="#FAFAFA">
										...
										<td>
											<div style="padding-left:10px">
												<input type="text" name="dbvar_str_telefone_2" id="dbvar_str_telefone_2" size="20" maxlength="50" value="<?php echo getValue($objRS,"endprin_fone2"); ?>">
											</div>
										</td>
									</tr>
									<tr>
										...
										<td>
											<div style="padding-left:8px">
												<table align="left">
													<tr>
														<td>
															<input type="text" name="dbvar_str_cep_cob" id="dbvar_str_cep_cob" size="10" maxlength="8" value="<?php echo getValue($objRS,"endcobr_cep"); ?>" onKeyPress="return validateNumKey(event)">
														</td>
														<td>
															<div style="cursor: pointer;">
										...
										<td>
											<div style="padding-left:8px">
												<table align="left">
													<tr>
														<td>
															<input type="text" name="dbvar_str_rotulo_entrega" id="dbvar_str_rotulo_entrega" size="34" value="<?php echo getValue($objRS,"endcobr_rotulo"); ?>">
														</td>
														<td>
										...
										<td>
											<div style="padding-left:8px">
												<table align="left">
													<tr>
														<td>
															<input type="text" name="dbvar_str_logradouro_cob" id="dbvar_str_logradouro_cob" size="45" value="<?php echo getValue($objRS,"endcobr_logradouro"); ?>">
														</td>
														<td>
															<div class="comment_peq">(Ex: Rua, Avenida, etc.)</div>
														</td>
										...
										<td>
											<div style="padding-left:8px">
												<table>
													<tr>
														<td>
															<input type="text" name="dbvar_str_numero_cob" id="dbvar_str_numero_cob" size="5" maxlength="6" value="<?php echo getValue($objRS,"endcobr_numero"); ?>">
														</td>
														<td>
															<div style="padding-left:8px">
																<input type="text" name="dbvar_str_complemento_cob" id="dbvar_str_complemento_cob" size="10" maxlength="" value="<?php echo getValue($objRS,"endcobr_complemento"); ?>">
															</div>
														</td>
													</tr>
												</table>
									...
									<tr>
										...
										<td>
											<div style="padding-left:10px"><input type="text" name="dbvar_str_bairro_cob" id="dbvar_str_bairro_cob" size="25" value="<?php echo getValue($objRS,"endcobr_bairro"); ?>">
											</div>
										</td>
									</tr>
									<tr bgcolor="FAFAFA">
										...
										<td>
											<div style="padding-left:8px">
												<table align="left">
													<tr>
														<td>
															<input type="text" name="dbvar_str_cidade_cob" id="dbvar_str_cidade_cob" size="30" value="<?php echo getValue($objRS,"endcobr_cidade"); ?>">
														</td>
														<td align="right" style="padding-left: 10px;" >
															<b>UF: </b>
														</td>
														<td>
															<div style="padding-left:5px;">
																<select name="dbvar_str_uf_cob" id="dbvar_str_uf_cob" style="width: 45px;">
										 						<?php echo(montaCombo($objConn,"SELECT sigla_estado FROM lc_estado ORDER BY sigla_estado","sigla_estado","sigla_estado",getValue($objRS,"endcobr_estado"))); ?>
											 					</select>
															</div>
														</td>
														<td align="right" style="padding-left: 10px;" ><b>BRASIL</b></td>
									...
									<tr>
										...
										<td>
											<div style="padding-left:10px">
												<input type="text" name="dbvar_str_telefone_cob" id="dbvar_str_telefone_cob" size="20" maxlength="50" value="<?php echo getValue($objRS,"endcobr_fone1"); ?>">
											</div>
										</td>
									</tr>
									<tr  bgcolor="#FAFAFA">
										...
										<td>
											<div style="padding-left:10px">
												<input type="text" name="dbvar_str_telefone_2_cob" id="dbvar_str_telefone_2_cob" size="20" maxlength="50" value="<?php echo getValue($objRS,"endcobr_fone2"); ?>">
											</div>	
										</td>
									</tr>
									<tr>
