...
<table width="100%" border="0" bgcolor="#FFFFFF">
			...
			<tr >
				<td colspan="2" valign="middle" style="background: #366092;color: white; width: 100%; height: 30px;font-size: 20px;text-align:center;" ><strong>RECEPÇÃO DOS LOCAIS DE ATENDIMENTO</strong></td>
            </tr>
            <tr >
            ...
            <tr>
                <td>
                    <table width="100%" border="0" class="bordasimples" cellspacing="0">
                        <thead>
                            <tr>
                                <th width="5%" style="background: #366092;color: white; font-size: 8px;text-align:center;"><font size="2">Nº ANS</font></th>
                                ...
                                <th width="25%"style="background: #366092;color: white; font-size: 8px;text-align:center;"><font size="2">LOCAIS COBERTOS PELA PRÓPRIA OPERADORA ONDE SEUS BENEFICIÁRIOS NÃO DEVEM SER ATENDIDOS PELO ATENDIMENTO ABRAMGE</font></th>
                                <th width="25%"style="background: #366092;color: white; font-size: 8px;text-align:center;"><font size="2">RAZÃO SOCIAL DA OPERADORA</font></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php 
