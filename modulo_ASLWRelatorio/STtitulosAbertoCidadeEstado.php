				...
				try{  		
						...
						$dblTotalGeral  = 0;
							foreach($objResult as $objRS) {
								...
								if ( (getValue($objRS,"uf_extendido") != $strUfAnterior ) && ($dblTotalEstado != 0) ){
                                    //if 	(($dblTotalEstado != 0) ){
                                        //if (1==2){
                                ?>
								...
								<?php if(getValue($objRS,"uf_extendido") != $strUfAnterior) { ?>
								<tr> 
                                           <td colspan='2' align="right"></td>
                                            <td colspan='3' style="font-size:16px; font-weight:bold;">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo(getValue($objRS,"uf_extendido"))?></tr>
                                            
                            			</tr>
								
								<?php } //estado?>
                                
                               <?php if($strCidadeAnterior != getValue($objRS,"cidade") ){ ?> 
                                       <tr> 
                                           <td colspan='2' align="right"></td>
                                            <td  colspan='3'  style="font-size:16px; font-weight:bold;"><?php echo(getValue($objRS,"cidade"))?></tr>
                                            
                            			</tr>
                                        <?php } //if cidade
							$strCidadeAnterior = getValue($objRS,"cidade"); 
							$strUfAnterior = getValue($objRS,"uf_extendido");
								...
								?>
										...
										<tr>
											...
											<td><center><font size='2'><?php echo(getValue($objRS,"codigo_ans"));?></font></center></td>
								...
								<?Php
										...
										$dblTotalCidade = $dbTotalCidade + getValue($objRS,"vlr_conta");
