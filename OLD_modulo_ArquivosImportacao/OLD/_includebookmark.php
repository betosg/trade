				...
				foreach($objResult as $objRS){
					...
					if(getValue($objRS,"categoria") != $strCategoria){
						...
						echo("
									...
									<tr onClick=\"collapseItem(" . $intI . ");\">
										<td width=\"99%\" bgcolor=\"#E0E0E0\" style=\"border-bottom:1px solid #999999;padding:3px;cursor:pointer\"><b>" . getValue($objRS,"categoria") . "</b></td>
										<td width=\"1%\" bgcolor=\"#E0E0E0\" style=\"border-bottom:1px solid #999999;padding:3px;cursor:pointer\"><img id=\"bookmark_img_" . $intI . "\" src=\"../img/collapse_generic_open.gif\"></td>
									</tr>
									<tr><td height=\"5\" colspan=\"2\"></td></tr>
									<tr>
										<td colspan=\"2\">
