...
fdTableSort = {
                        ...
                        for(c = 0;c < workArr.length;c++) {
                                for(i = 0;i < workArr[c].length;i++){
                                        ...
                                        if(workArr[c][i].className.match('sortable')) {
                                                ...
                                                aclone.title = "Ordenar por \u201c" + thtext.replace('<br />', '') + "\u201d";
        ...
        initSort: function(noCallback, ident) {
                ...
                if(!dataObj.noArrow) {
                        ...
                        if(span.firstChild) span.removeChild(span.firstChild);
						//Como nosso CSS muda o fundo indicando seta pra baixo e para cima, não precismaos colocar esses caracteres indicando isso
        ...
        redraw: function(tableid, identical) {
                ...
                for(var i = 0; i < len1; i++) {
                        ...
                        if(!identical) {
                                ...
                                // Netscape 8.1.2 requer o removeChild senão ele "freaks out", se quisermos suportar ele temos de descomentar a linha debaixo
                                // hook.removeChild(tr);
                                hook.appendChild(tr);
                        };
                };
