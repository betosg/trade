...
try{
	...
	$strSQL .= " VALUES (" . $intCodDado . ", '" . $strTipo . "', " . $intCodigo . ", " . $intCodConta . ", " . $intCodPlanoConta . ", " . $intCodCentroCusto . ", " . $intCodJob . ", '" . $strHistorico . "', '" . $strObs . "', '" . $strNumLcto . "', '" . $dateNumLctoNorm	. "', " . $dblVlrLctoNorm . ", " . $dblVlrMulta . ", " . $dblVlrJuros . ", " . $dblVlrDesc . ", CURRENT_TIMESTAMP, '" . getsession(CFG_SYSTEM_NAME . "_id_usuario") . "', '" . $strDocumento . "', '" . $numDocumento . "', '" . $strExtraDocumento . "') ";
