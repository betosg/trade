<?php
	...
	try{
		...
		FROM fin_conta_pagar_receber
			INNER JOIN fin_lcto_ordinario ON fin_conta_pagar_receber.cod_conta_pagar_receber = fin_lcto_ordinario.cod_conta_pagar_receber
			...
			WHERE fin_lcto_ordinario.cod_lcto_ordinario = " . $intCodLctoOrdinario;
	...
	if($objRS = $objResult->fetch()) {
		...
		if(getValue($objRS,"tipo") == "cad_pj_fornec" and is_numeric($intCodigoTipo)) { 
			$strSQL = "SELECT nome_fantasia AS nome FROM cad_pj_fornec WHERE cod_pj_fornec =" . $intCodigoTipo; 
		}
...
<html>
	<head>
		...
		<script language="JavaScript" type="text/javascript">
			...
			function ok() {
				strLocation = "../modulo_FinContaPagarReceber/STifrlancamentoSinog.php?var_chavereg=<?php echo($intCodTitulo)?>";
				submeterForm();
			}

			function cancelar() {
				document.location.href = "../modulo_FinContaPagarReceber/STifrlancamentoSinog.php?var_chavereg=<?php echo($intCodTitulo)?>";
			}

			//function aplicar() {
			//	strLocation = "../modulo_FinContaPagarReceber/STinslctoordinarioSinog.php?var_chavereg=<?php echo($intCodTitulo)?>";
			//	submeterForm();
			//}
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
	 <tr>
	   <td align="center" valign="top">
		<?php athBeginFloatingBox("600","none",$strTITULO . " - " . getTText("lcto_ord",C_UCWORDS),CL_CORBAR_GLASS_1) . " - Edição"; ?>
			<table border="0" width="100%" bgcolor="#FFFFFF" style="border:1px #A6A6A6 solid;">
			  <form name="formconf" action="STupdlctoordinarioexecSinog.php" method="post">
				...
				<input type="hidden" name="var_cod_lcto_ordinario" value="<?php echo($intCodLctoOrdinario);?>">
				<tr>
					<td align="center" valign="top">
						<table width="500" border="0" cellspacing="0" cellpadding="4">
							...
							<!--tr> 
								...
								<td valign="middle"> 
									<select name="var_cod_conta" class="edtext" style="width:230px;" disabled>
										...
										<tr>
											<td style="padding-right:3px;" valign="middle">
												<select name="var_cod_centro_custo" class="edtext" style="width:230px;">
													<?php echo(montaCombo($objConn,"SELECT cod_centro_custo, nome FROM fin_centro_custo ORDER BY 2","cod_centro_custo","nome",getValue($objRS,"cod_centro_custo"))); ?>
												</select>
											</td>
											<td valign="middle">
											...
											<td>
												<table cellpadding="0" cellspacing="0" width="100%" border="0">
													...
													<tr>
														...
														<td align="right"><?php echo($dblVlrTotalDebito); ?></td>
													</tr>
							...
							<tr> 
								...
								<td valign="middle"><textarea name="var_obs" class="edtext" rows="7" style="width:357px;"><?php echo(getValue($objRS,"observacao"));?></textarea></td>
							</tr>
							<tr><td colspan="2" height="10" bgcolor="#FFFFFF"></td></tr>
							<!--tr>
								<td></td>
