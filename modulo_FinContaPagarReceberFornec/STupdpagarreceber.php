...
getsession($strSesPfx . "_chave_app");
getsession(CFG_SYSTEM_NAME . "_cod_usuario");
				...
				<td align="center" valign="top">
					<table width="550" border="0" cellspacing="0" cellpadding="4">
								...
								<table border="0px" cellpadding="0px" cellspacing="0px">
									<tr>
										<td style="padding-right:5px;" valign="middle">
										  <input name='var_codigo' value='<?php echo(getValue($objRS,"codigo")); ?>' class='edtext' type='text' maxlength='10' style='width:40px;'
						...
						<tr bgcolor="#FFFFFF">
							...
							<td align="left"><input name='var_ano_vcto' id='var_ano_vcto' class='edtext' value="<?php echo(getValue($objRS,"ano_vcto")); ?>" type='text' maxlength='4' style='width:50px;' onKeyPress="Javascript:return validateNumKey(event);"></td>
						</tr>
						<tr>
