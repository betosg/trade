...
$strPARAM = $strPARAM . "&itemDescription1=".$intCodDado." - ".$DadosBoleto_HISTORICO . " - " .$DadosBoleto_SACADO_NOME;
...
$strPARAM = $strPARAM . "&senderEmail=tatianajf@sandbox.pagseguro.com.br";
...
$strPARAM = $strPARAM . "&shippingAddressCountry=";
