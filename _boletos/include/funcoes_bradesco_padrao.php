...
$nnum = formata_numero($dadosboleto["carteira"],3,0).formata_numero($dadosboleto["nosso_numero"],11,0);
//dv do nosso número
...
$nnum_reduzido = substr($nnum,-13);
$dv = digitoVerificador_barra("$codigobanco$nummoeda$fator_vencimento$valor$agencia$nnum_reduzido$conta_cedente".'0', 9, 0);
// Numero para o codigo de barras com 44 digitos
$linha = "$codigobanco$nummoeda$dv$fator_vencimento$valor$agencia$nnum_reduzido$conta_cedente";

$nossonumero = substr($nnum,0,3).'/'.substr($nnum,3).'-'.$dv_nosso_numero;
//$agencia_codigo = $agencia."-".$conta_dv." / ". $conta_cedente ."-". $conta_cedente_dv;
$agencia_codigo = $agencia." / ".$conta_cedente."-".$conta_cedente_dv;


$dadosboleto["codigo_barras"] = $linha;
$dadosboleto["linha_digitavel"] = monta_linha_digitavel($linha."0");
...
//Guarda inicial
?><img src=../_boletos/imagens/p.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=../_boletos/imagens/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=../_boletos/imagens/p.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=../_boletos/imagens/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
<?php
$texto = $valor ;
if((strlen($texto) % 2) <> 0){
...
?>
    src=../_boletos/imagens/p.png width=<?php echo $f1?> height=<?php echo $altura?> border=0><img 
<?php
    if (substr($f,$i,1) == "0") {
      $f2 = $fino ;
    }else{
...
?>
    src=../_boletos/imagens/b.png width=<?php echo $f2?> height=<?php echo $altura?> border=0><img 
<?php
  }
}
...
// Draw guarda final
?>
src=../_boletos/imagens/p.png width=<?php echo $largo?> height=<?php echo $altura?> border=0><img 
src=../_boletos/imagens/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=../_boletos/imagens/p.png width=<?php echo 1?> height=<?php echo $altura?> border=0> 
  <?php
} //Fim da função
