...
$nnum = formata_numero(substr($dadosboleto["nosso_numero"],-8),8,0);
//echo "<br> mod 10: ".modulo_10($agencia.$conta.$carteira.$nnum);
//echo "<br> concat: ".$agencia.$conta.$carteira.$nnum;
...
function modulo_10($num) { 
        ...
        for ($i = strlen($num); $i > 0; $i--) {
            ...
            //echo  "<br> nros: ".$numeros[$i] . " fator: " .$fator . " total: ". $temp;
            $temp0=0;
