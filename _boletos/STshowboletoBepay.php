...
//se nao tem boleto, gera novamente o mesmo, pois tivemos problemas com boletos passados em funï¿½ï¿½o da biblioteca do bradesco.
//caso nao tenha, serï¿½o lidos os dados e inseridos novamente para que ganhe um novo ID do boleto, bem como sera excluido o boleto antigo para fins de seguranï¿½a
...
if (!phoneValidate($strCelular)){
	$strMsg .=  " - CELULAR invï¿½lido.\\r\\n O nï¿½mero deve ser composto por 11 98888-7777.";
}
