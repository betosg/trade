			...
			//var_dump(get_resource_type($ch));
						if ($strTipo == "boleto"){
                            ...
                            try{
                                  ...
                                  //          values  ('".$DadosBoleto_SACADO_NOME."','".$DadosBoleto_SACADO_EMAIL."',".$intCodDado.", '".$data_post."', '" . $result . "', '".$strUserLogado."',now(), '".$transactionId."','".$strIdentificador."') ";
                                  //  $objResult = $objConn->query($strSQL);
...
/*	=======================================================
					...
					BUSCA DADOS EXTRATO 
						...
						$headers[] = "Transaction-Hash: ".trim($AuthorizationHeaderBase64);
							...
							$strNomeExtrato = "";
							//$transactionId = "E1F2AC5E-7021-64BD-397C-8E36DC8DE83A";
