...
$dadosboleto["nosso_numero"] = "13841";  			// Nosso numero (máx. 5 digitos) - Numero sequencial de controle.
...
$dadosboleto["aceite"] = "N";	    // NAO - remeter cobrança sem aceite do sacado  (cobranças não-registradas) 
                                  // SIM - remeter cobrança apos aceite do sacado (cobranças registradas)
...
$dadosboleto["agencia"] = "718"; 	// Num da agencia, sem digito
$dadosboleto["conta"] = "30147"; 	// Num da conta, sem digito
$dadosboleto["conta_dv"] = "2"; 	// Digito do Num da conta

// DADOS PERSONALIZADOS - SICREDI
$dadosboleto["posto"]= "29";      // Código do posto da cooperativa de crédito
$dadosboleto["byte_idt"]= "5";	  // Byte de identificação do cedente do bloqueto utilizado para compor o nosso número.
