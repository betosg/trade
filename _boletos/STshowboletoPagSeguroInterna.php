...
$strPARAM = $strPARAM . "&shippingAddressStreet=".$DadosBoleto_SACADO_LOGRADOURO;
$strPARAM = $strPARAM . "&shippingAddressNumber=".$DadosBoleto_SACADO_NUMERO;
$strPARAM = $strPARAM . "&shippingAddressComplement=".$DadosBoleto_SACADO_COMPLEMENTO;
$strPARAM = $strPARAM . "&shippingAddressDistrict=".$DadosBoleto_SACADO_BAIRRO;
$strPARAM = $strPARAM . "&shippingAddressPostalCode=".$DadosBoleto_SACADO_CEP;
$strPARAM = $strPARAM . "&shippingAddressCity=".$DadosBoleto_SACADO_CIDADE;
$strPARAM = $strPARAM . "&shippingAddressState=".$DadosBoleto_SACADO_ESTADO;
...
//  echo "cURL Error #:" . $err;
  ...
  $urlBoleto = "https://pagseguro.uol.com.br/v2/checkout/payment.html?code=".$strAuth;
			...
			//var_dump(get_resource_type($ch));
							...
							if ($urlBoleto!=""){
                                print("<br><br><p align='center'><img src='../modulo_PainelPF/logo_pagseguro244x50.png'><br><a href='".$urlBoleto."' target='_blank'>Clique aqui </a><script>window.location.href = '".$urlBoleto."';</script></p>");
							//echo $urlBoleto;
