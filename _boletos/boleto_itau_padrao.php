...
// DADOS DO SEU CLIENTE
$dadosboleto["sacado"] = $DadosBoleto_SACADO_NOME ."   CNPJ: ".$DadosBoleto_SACADO_CNPJ; //"Nome do seu Cliente";
$dadosboleto["endereco1"] = $DadosBoleto_SACADO_LOGRADOURO . ", " . $DadosBoleto_SACADO_NUMERO . " " . $DadosBoleto_SACADO_COMPLEMENTO; //"Endereço do seu Cliente";
$dadosboleto["endereco2"] = $DadosBoleto_SACADO_CIDADE . " - " . $DadosBoleto_SACADO_ESTADO . " - CEP: " . $DadosBoleto_SACADO_CEP; //"Cidade - Estado -  CEP: 00000-000";
...
$dadosboleto["especie"] = $DadosBoleto_ESPECIE;
...
$dadosboleto["cedente"] =  $DadosBoleto_CEDENTE_NOME_COMPLETO;
$dadosboleto["cpf_cnpj"] = $DadosBoleto_CEDENTE_CNPJ;
$dadosboleto["cedente_cpf_cnpj"] = $DadosBoleto_CEDENTE_CNPJ; //"";
$dadosboleto["endereco"] = $DadosBoleto_CEDENTE_LOGRADOURO . ", " . $DadosBoleto_CEDENTE_NUMERO . " " . $DadosBoleto_CEDENTE_COMPLEMENTO . ", " . $DadosBoleto_CEDENTE_BAIRRO; //"Coloque o endereço da sua empresa aqui";
$dadosboleto["cidade_uf"] = $DadosBoleto_CEDENTE_CIDADE . " / " . $DadosBoleto_CEDENTE_ESTADO . " - CEP:" . $DadosBoleto_CEDENTE_CEP; //"Cidade / Estado - CEP:";
