...
// +----------------------------------------------------------------------+
	...
	// Se for LABORAL é uma guia gerada para casos de multa e, no geral, será chamada de fora 
	// do sistema. Então ignora CNAE porque na guia gerada pela MIRAH isso não era obrigatório
