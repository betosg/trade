...
<html>
	<head>
		...
		<!--
			...
			function ok() {
				strLocation = "../modulo_FinContaPagarReceber/STifrlancamentoABFM.php?var_chavereg=<?php echo($intCodTitulo)?>";
				submeterForm();
			}

			function cancelar() {
				document.location.href = "../modulo_FinContaPagarReceber/STifrlancamentoABFM.php?var_chavereg=<?php echo($intCodTitulo)?>";
			}

			function aplicar() {
				strLocation = "../modulo_FinContaPagarReceber/STinslctoordinarioABFM.php?var_chavereg=<?php echo($intCodTitulo)?>";
				submeterForm();
			}
