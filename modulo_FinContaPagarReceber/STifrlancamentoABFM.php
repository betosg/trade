	 	...
	 	<script language="javascript">
			...
			function removeLancamento(prCodLancamento){
				if(confirm("Tem certeza que deseja remover este lançamento?")){
					window.location = 'STremovelancamentoABFM.php?var_chavereg=' + <?php echo($intCodTitulo); ?> + '&var_cod_lcto_ordinario=' + prCodLancamento;
				}
			}
		</script>
	</head>
			...
			<td align="left">
				<?php
					...
					athBeginCssMenu();
						...
						athBeginCssSubMenu();
							athCssMenuAddItem("../modulo_FinContaPagarReceber/STinslctoordinarioABFM.php?var_chavereg=".$intCodTitulo,
	...
	<table align="center" cellpadding="0" cellspacing="1" style="width:100%" class="tablesort">
		<thead>
			<tr>
				...
				<th width="10%" nowrap>Data Pgto</th>
