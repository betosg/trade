   ...
   <td align="center" valign="top">
	<?php athBeginFloatingBox("750","none","<b>".getTText("titulo_deleta_lote",C_NONE)."</b>",CL_CORBAR_GLASS_1); ?>
      <table id="var_dialog" width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:1px solid #A6A6A6; display:block;">
        <form name="formfatura" action="STdeletaTituloLotePasso2exec.php" method="post">
        	<input type="hidden" name="var_identificador" id="var_identificador" value="<?php echo($strIdentificador); ?>">			
		...
		<tr> 
			<td align="center" valign="top">
				<table width="600" border="0" cellspacing="0" cellpadding="4">
					...
					<tr bgcolor="<?php echo(CL_CORLINHA_2);?>"><td align="left" style="padding-left:5px;" colspan="2">
					<span style="float:right;padding-right:3px;cursor:pointer;" onClick="displayArea('<?php echo(CFG_SYSTEM_NAME);?>_detailiframe')">
					    <img src="../img/icon_tree_minus.gif" border="0" id="img_collapse" /></span>Títulos em aberto que podem ser deletados no lote <strong><span style='color:red;'><?php echo($strIdentificador);?></span></strong></td></tr>
					<tr>
                    	<td height="165" colspan="2">
                        	 <iframe name="<?php echo(CFG_SYSTEM_NAME);?>_detailiframe" id="<?php echo(CFG_SYSTEM_NAME);?>_detailiframe" width="100%" height="100%" src="STincludeDeletaTituloLote.php?var_identificador=<?php echo($strIdentificador);?>" frameborder="0" scrolling="yes"></iframe>
                        </td>
					</tr>
