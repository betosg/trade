   ...
   <td align="center" valign="top">
	<?php athBeginFloatingBox("725","none","VALIDAÇÃO DE ARQUIVO (Upload)",CL_CORBAR_GLASS_1); ?>
      <table id="dialog" width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:1px solid #A6A6A6;">
        <form name="formarquivo" action="STArqValidaSICOBass.php" method="post">
		<tr>
			<td align="left" height="22" colspan="2" style="padding:1px 5px"><h2 style="color:#009966;">SICOB <font size="3" style="color:#009966;"> - Assistenciais</font></h2></td>
		</tr>
		<tr> 
			<td align="center" valign="top">
				<table width="550" border="0" cellspacing="0" cellpadding="4">
					...
					<tr bgcolor="#FAFAFA">
						...
						<td><input type="text" size="50" name="uploadArquivo" ><input type="button" class="inputclean	" onClick="callUploader('formarquivo','uploadArquivo','/<?php echo getSession(CFG_SYSTEM_NAME . "_dir_cliente"); ?>/upload/arqbanco/sicob/assisten/');" value="Upload"></td>
					</tr>
					<tr align="left">
