		<tr>
			<td colspan="2" ><br /><span style="color:#009966;float:right; font-size:18px; font-weight:bold" >SICOB - Assistenciais</span>
		...
		<tr bgcolor="#CCCCCC">
			<td colspan="2" align="left"><b><?php echo $_SESSION['ArqValida_linhaHeaderHA']; ?></b></td>
		</tr>
		<tr bgcolor="#FFFFFF">
