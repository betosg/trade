...
<table width="100%" border="0" cellpadding="0" cellspacing="1" style="border:0px solid #A6A6A6;">
  	<tr>
    	...
    	<?php athBeginFloatingBox("570","none","DEFINIÇÕES GERAIS - Validação de Arquivo (ASSISTENCIAIS)",CL_CORBAR_GLASS_1); ?>
    		<table id="dialog" width="100%" border="0" cellpadding="4" cellspacing="0" bgcolor="#FFFFFF" style="border:1px solid #A6A6A6;">
				<form name="formImpor" action="../modulo_ArquivosValidacao/STimportacaoDatabaseSICOBass.php" method="post">
				<input type="hidden" name="uploadArquivo" value="<?php echo $nameArq; ?>">
      			<tr>
	    			<td colspan="2"  style="padding:1px 50px 1px 50px;" ><br /><span style="color:#009966;float:right; font-size:18px; font-weight:bold" >SICOB - Assistenciais</span><!-- span style="float:left;" class="destaque_gde"><strong>Dados do Arquivo</strong></span--></td>
    			</tr>
				<tr>
					<td align="center" valign="top" style="padding:20px 50px 10px 50px;" width="1%">
						<table cellpadding="4" cellspacing="0" border="0" width="100%">
							<tr>
								<td></td>
								<td align="left" valign="top" class="destaque_gde"><strong>DEFINIÇÕES GERAIS</strong></td>
							</tr>
							<tr><td colspan="2" height="2" align="center" background="../img/line_dialog.jpg"></td></tr>
							<tr bgcolor="<?php echo(CL_CORLINHA_1)?>">
								<td align="right" width="23%"><strong>Cód. do Banco:</strong></td>
								<td width="77%">&nbsp;<?php echo $_SESSION['ArqValida_codBancoHA']; ?></td>
							</tr>
							<tr bgcolor="<?php echo (CL_CORLINHA_2)?>">
								<td align="right"><strong>Nº de Inscr. da Empresa:</strong></td>
							...
							<tr bgcolor="<?php echo(CL_CORLINHA_1)?>">
								...
								<select name="var_cod_conta" id="var_cod_conta" style="width:250px;" size="1">
									...
									<?php echo(montaCombo($objConn,"SELECT cod_conta, cod_conta||' - '||nome AS nome FROM fin_conta ORDER BY ordem, nome ","cod_conta","nome")); ?>
								</select>
								</td>
							</tr>
							<tr bgcolor="<?php echo(CL_CORLINHA_2)?>">
								<td align="right"><strong>Plano de Contas:</strong> </td>
								<td>&nbsp;
								<select name="var_cod_plano_conta" id="var_cod_plano_conta" style="width:250px;" size="1">
									...
									<?php echo(montaCombo($objConn,"SELECT cod_plano_conta, nome FROM fin_plano_conta ORDER BY ordem, nome ","cod_plano_conta","nome"));?>
								</select>
								</td>
							</tr>
							<tr bgcolor="<?php echo(CL_CORLINHA_1)?>">
								...
								<select name="var_cod_centro_custo" id="var_cod_centro_custo" style="width:250px;" size="1">
									...
									<?php echo(montaCombo($objConn,"SELECT cod_centro_custo, nome FROM fin_centro_custo ORDER BY ordem, nome ","cod_centro_custo","nome"));?>
								</select>
								</td>
							</tr>
							...
							<tr><td colspan="2" height="2" align="center" background="../img/line_dialog.jpg"></td></tr>
							<tr bgcolor="<?php echo(CL_CORLINHA_1)?>">
								<td align="right"><input type="radio" name="var_opcao_baixa" id="var_opcao_baixa1" value="usar_ocorrencia" class="borda" checked="checked"></td>							  		
								<td>Usar a Data de OCORRÊNCIA para efetuar a baixa.</td>
							</tr>
							<tr bgcolor="<?php echo(CL_CORLINHA_2)?>">
								<td align="right"><input type="radio" name="var_opcao_baixa" id="var_opcao_baixa2" value="usar_credito" class="borda"></td>
				...
				<tr>
					<td style="padding: 0px 0px 20px 0px;">
						<table cellpadding="4" cellspacing="0" border="0" style="padding: 0px 0px 0px 0px;" align="center" width="80%">
							<tr>
								<td width="1%" align="right" style="padding:10px 00px 10px 10px;" nowrap>
