...
<!--3--><td align="right"><b>Tipo de Registro</b></td>
	...
	<tr bgcolor="#FAFAFA">
<!--4--><td align="right"><b>Tipo de Operação</b></td>
		<td><div style="padding-left:10px"><?php echo $_SESSION['ArqValida_AFAtipOperHL']; ?></div></td>
	</tr>
	<tr bgcolor="#FFFFFF">
<!--5--><td align="right"><b>Tipo de Serviço</b></td>
...
<!--6--><td align="right"><b>Uso Exclusivo FEBRABAN/CNAB</b></td>
	...
	<tr bgcolor="#FFFFFF">
<!--7--><td align="right"><b>Nº da Versão do Layout do Lote</b></td>
...
<!--8--><td align="right"><b>Uso Exclusivo FEBRABAN/CNAB</b></td>
	...
	<tr bgcolor="#FFFFFF">
<!--9--><td align="right"><b>Tipo de Inscrição da Empresa</b></td>
		<td><div style="padding-left:10px"><?php echo $_SESSION['ArqValida_tipInsEmpHL']; ?></div></td>
	</tr>
	<tr bgcolor="#FAFAFA">
<!--10--><td align="right"><b>Nº de Inscrição da Empresa</b></td>
		<td><div style="padding-left:10px"><?php echo $_SESSION['ArqValida_insEmpHL']; ?></div></td>
	</tr>
	<tr bgcolor="#FFFFFF">
<!--11--><td align="right"><b>Código do Convênio do Banco</b></td>
...
<!--14--><td align="right"><b>Digito Verificador da Conta</b></td>
	...
	<tr bgcolor="#FFFFFF">
<!--15--><td align="right"><b>Número da Conta Corrente</b></td>
		<td><div style="padding-left:10px"><?php echo $_SESSION['ArqValida_numConCorrHL']; ?></div></td>
	</tr>
	<tr bgcolor="#FAFAFA">
<!--16--><td align="right"><b>Dígito Verificador da Conta</b></td>
		<td><div style="padding-left:10px"><?php echo $_SESSION['ArqValida_digVerConHL']; ?></div></td>
	</tr>
	<tr bgcolor="#FFFFFF">
<!--17--><td align="right"><b>Dígito Verif. Ag./Ced (sem operação)</b></td>
...
<!--21--><td align="right"><b>Numero Remessa/Retorno</b></td>
	...
	<tr bgcolor="#FAFAFA">
<!--22--><td align="right"><b>Data de Gravação Remessa/Retorno</b></td>
		<td><div style="padding-left:10px"><?php echo $_SESSION['ArqValida_dtRemRetHL']; ?></div></td>
	</tr>
	<tr bgcolor="#FFFFFF">
<!--23--><td align="right"><b>Data do Crédito</b></td>
