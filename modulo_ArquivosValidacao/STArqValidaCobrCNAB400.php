					...
					<tr>
						<td valign="top" align="center"> 
							<table width="500"  border="0" cellpadding="2" cellspacing="0">
								<tr><td><table><?php include_once("_STincludeHeaderArquivoCobrCNAB400.php");?></table></td></tr>
								<tr><td><table><?php include_once("_STincludeTransacaoTipo1CobrCNAB400.php"); ?></table></td></tr>
								<tr><td><table><?php include_once("_STincludeTransacaoTipo3CobrCNAB400.php"); ?></table></td></tr>
								<tr><td><table><?php include_once("_STincludeTrailerArquivoCobrCNAB400.php"); ?></table></td></tr>
...
<!-- *** VERIFICAÇÃO SE SOMENTE FOI VALIDADO OU IMPORTADO *** -->
								...
								<tr>
									...
									<form name="formArqValida" action="STdialogCobrCNAB400.php" method="post" >
