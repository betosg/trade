...
include_once("STValidacaoToolsCobrCNAB400Itau.php");
...
for($z=0; $z < count($fp); $z++){
	...
	@$first_Number = $linha[0].$linha[1];
	if((!ctype_digit($first_Number)) and ($fp[$z] <> "")){
		die(mensagem("err_sql_titulo","err_arq_desc","Arquivo Inválido para Validação.","STArqUploadCobrCNAB400.php","erro",1));
	} else{
		verificaLinha($linha);
	}
}
					...
					<tr>
						<td valign="top" align="center"> 
							<table width="500"  border="0" cellpadding="2" cellspacing="0">
								<tr><td><table><?php include_once("_STincludeHeaderArquivoCobrCNAB400Itau.php");?></table></td></tr>
								<tr><td><table><?php include_once("_STincludeTransacaoTipo1CobrCNAB400Itau.php"); ?></table></td></tr>
								<!--tr><td><table><?php //include_once("_STincludeTransacaoTipo3CobrCNAB400Itau.php"); ?></table></td></tr-->
								<tr><td><table><?php include_once("_STincludeTrailerArquivoCobrCNAB400Itau.php"); ?></table></td></tr>
<!-- *** VERIFICAÇÃO SE SOMENTE FOI VALIDADO OU IMPORTADO *** -->
<?php
$id_arq = $_SESSION['ArqValida_DataGravacaoArqHA'];
if ($id_arq != "") {
...
<!-- *** VERIFICAÇÃO SE SOMENTE FOI VALIDADO OU IMPORTADO *** -->
								...
								<tr>
									...
									<form name="formArqValida" action="STdialogCobrCNAB400Itau.php" method="post" >
