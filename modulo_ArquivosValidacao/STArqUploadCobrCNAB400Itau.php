...
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
	<tr>
		...
		<?php athBeginFloatingBox("725","none","VALIDAÇÃO DE ARQUIVO (Upload)",CL_CORBAR_GLASS_1); ?>
      	<table id="dialog" width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:1px solid #A6A6A6;">
        	<form name="formarquivo" action="STArqValidaCobrCNAB400Itau.php" method="post">
			<tr><td align="left" height="22" colspan="2" style="padding:1px 5px"><h2 style="color:#D1343B;">Cobrança CNAB400<font size="3" style="color:#D1343B;"></font></h2></td></tr>
			<tr> 
				<td align="center" valign="top">
					<table width="550" border="0" cellspacing="0" cellpadding="4">
						<tr bgcolor="#FFFFFF">
							<td width="1%" align="right" valign="top"><strong></strong>&nbsp;</td><td><?php echo(getTText("msg_arquivo_validacao",C_NONE)); ?></td>
						</tr>
						<tr bgcolor="#FAFAFA">
							<td width="1%" align="right" valign="top"><strong><?php echo(getTText("arquivo",C_NONE)); ?>:</strong>&nbsp;</td>
							<td><input type="text" size="50" name="uploadArquivo" ><input type="button" class="inputclean" onClick="callUploader('formarquivo','uploadArquivo','/<?php echo getSession(CFG_SYSTEM_NAME . "_dir_cliente"); ?>/upload/arqbanco/cobrcnab400/');" value="Upload"></td>
						</tr>
						...
						<tr>
							<td colspan="2">
								<table border="0" cellpadding="0" cellspacing="0" width="100%">
									<tr>
										<td width="1%" align="right" style="padding:10px 0px 10px 10px;" nowrap><button onClick="aplicar(); return false;"><?php echo(getTText("aplicar",C_UCWORDS)); ?></button></td>
									</tr>
								</table>
							</td>
						</tr> 
