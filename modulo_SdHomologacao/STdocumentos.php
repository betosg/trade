...
<body bgcolor="#FFFFFF">
	...
	<tr>
		...
		<?php
			// MENU DE DOCUMENTOS
			athBeginCssMenu();
				athCssMenuAddItem("","_self",getTText("documentos",C_TOUPPER),1);
				athBeginCssSubMenu();
					athCssMenuAddItem("STinsdocumento.php?var_chavereg=".$intCodDado,"_self",getTText("documento_inserir",C_NONE));
				athEndCssSubMenu();
			athEndCssMenu();		
		?>
		</td>
