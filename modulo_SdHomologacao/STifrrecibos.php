			...
			<td align="left">
				<?php
					...
					athBeginCssMenu();
						...
						athBeginCssSubMenu();
							athCssMenuAddItem("../modulo_SdHomologacao/STshowrecibo.php?var_chavereg=".$intCodDado."&var_cod_conta_pagar_receber=".$intTITULO,"_self",getTText("recibo_inserir",C_NONE));
						athEndCssSubMenu();
					athEndCssMenu();		
				?>
			</td>
