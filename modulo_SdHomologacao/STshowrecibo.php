	...
	<head>
		...
		<script type="text/javascript">
			...
			function ok() {
				...
				document.location.href = "../modulo_SdHomologacao/STifrrecibos.php?var_cod_conta_pagar_receber=<?php echo($intTITULO);?>&var_chavereg=<?php echo($intCodDado);?>";
			}
		...
		<td colspan="3">
			<table cellspacing="0" cellpadding="0" border="0" width="100%">
				<tr>
					...
					<!-- goNext() -->
					<td width="55%" align="right"><button onClick="ok();return false;"><?php echo(getTText("ok",C_NONE));?></button></td>
