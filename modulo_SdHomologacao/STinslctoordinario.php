<?php
	...
	$intCodTitulo 			 = request("var_cod_titulo");
...
<html>
	<head>
		...
		<!--
			...
			function ok() {
				strLocation = "../modulo_SdHomologacao/STifrlancamento.php?var_chavereg=<?php echo(request("var_chavereg"));?>&var_cod_titulo=<?php echo(request("var_cod_titulo"))?>";
				submeterForm();
			}

			function cancelar() {
				document.location.href = "../modulo_SdHomologacao/STifrlancamento.php?var_chavereg=<?php echo(request("var_chavereg"));?>&var_cod_titulo=<?php echo(request("var_cod_titulo"))?>";
			}

			function aplicar() {
				strLocation = "../modulo_SdHomologacao/STinslctoordinario.php?var_chavereg=<?php echo(request("var_chavereg"));?>&var_cod_titulo=<?php echo(request("var_cod_titulo"))?>";
				submeterForm();
			}
