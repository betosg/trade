				...
				<td align="center" valign="top">
					<table width="550" border="0" cellspacing="0" cellpadding="4">
						...
						<tr bgcolor="#FAFAFA"> 
							...
							<td valign="middle"><input name='dbvar_date_dt_cred' id='VAR_DT_CRED' class='edtext' value='' type='text' maxlength='10' style='width:70px;' onKeyPress='Javascript:return validateNumKey(event);' onKeyUp='Javascript:FormataInputData(this,2);'><span class="texto_corpo_peq"></span></td>
						</tr>
						<tr> 
