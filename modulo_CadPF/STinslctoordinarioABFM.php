<?php
	...
	$intCodResize			 = request("var_cod_resize");
...
<html>
	<head>
		...
		<!--
			...
			function ok() {
				strLocation = "../modulo_CadPF/STifrlancamentoABFM.php?var_chavereg=<?php echo($intCodTitulo)?>&var_cod_resize=<?php echo($intCodResize);?>";
				submeterForm();
			}

			function cancelar() {
				document.location.href = "../modulo_CadPF/STifrlancamentoABFM.php?var_chavereg=<?php echo($intCodTitulo)?>&var_cod_resize=<?php echo($intCodResize);?>";
			}

			function aplicar() {
				strLocation = "../modulo_CadPF/STinslctoordinarioABFM.php?var_chavereg=<?php echo($intCodTitulo)?>&var_cod_resize=<?php echo($intCodResize);?>";
				submeterForm();
			}
	   ...
	   <td align="center" valign="top">
		<?php athBeginFloatingBox("600","none",$strTITULO . " - " . getTText("lcto_ord",C_UCWORDS),CL_CORBAR_GLASS_1); ?>
			<table border="0" width="100%" bgcolor="#FFFFFF" style="border:1px #A6A6A6 solid;">
			  <form name="formconf" action="STinslctoordinarioexecABFM.php" method="post">
						...
						<table width="500" border="0" cellspacing="0" cellpadding="4">
							...
							<tr>
								...
								<td>
									<select name="var_documento">
										...
										<!--<option value="BOLETO"><?php //echo(getTText("boleto",C_UCWORDS)); ?></option>-->
							...
							<tr>
								<td align="right" colspan="3" style="padding:10px 0px 10px 10px;">
									<button onClick="ok();" class="inputcleanActionOk">
										Enviar
									</button>
									<button onClick="cancelar();return false;" class="inputcleanActionCancelar">
