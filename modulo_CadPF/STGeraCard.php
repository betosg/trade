...
if($intCodDado == ""){
	...
	$intCodCredencial =  (getValue($objRS,"cod_credencial") == "") ? ""  : getValue($objRS,"cod_credencial");
	$strNomePF =  (getValue($objRS,"pf_nome") == "") ? ""  : getValue($objRS,"pf_nome");
	$strRazaoSocial =  (getValue($objRS,"pf_empresa") == "") ? ""  : getValue($objRS,"pf_empresa");
	$intRG = (getValue($objRS,"pf_rg") == "") ? "" : getValue($objRS,"pf_rg");
	$intCPF = (getValue($objRS,"pf_cpf") == "") ? "" : getValue($objRS,"pf_cpf");
	...
	$intNumMatricula = (getValue($objRS,"pf_matricula") == "") ? "" : getValue($objRS,"pf_matricula");
	$intCodPedido = (getValue($objRS,"cod_pedido") == "") ? "" : getValue($objRS,"cod_pedido");
	$intQtdeImpr = (getValue($objRS,"qtde_impresso") == "") ? "" : getValue($objRS,"qtde_impresso");
}
					...
					<?php if($intQtdeImpr == 0) {?>	
								...
								<table cellpadding="0" cellspacing="0" border="0" style="padding: 0px 0px 0px 0px;">
									<tr>
										...
										<td align="left" style="padding: 0px 0px 0px 10px;">
											<?php echo(getTText("aviso_impr",C_NONE))?>
										</td>
								<?php 
									} else{
								?>
									<tr>
										<td style="padding: 0px 0px 20px 110px;">
											<table cellpadding="0" cellspacing="0" border="0">
												<tr>
													<td>
														<input type="radio" name="var_cobr" id="var_cobr" value="cobr_none" style="border:none; background-color:#FFFFFF">
													</td>
													<td nowrap="nowrap">
												...
												<tr>
													...
													<td nowrap="nowrap">
														<?php echo(getTText("gera_cobranca_normal",C_NONE))?>&nbsp;<input type="text" name="var_valor" id="var_valor" dir="rtl" size="15" onKeyPress="Javascript: validateFloatKey();" value="<?php echo($intValorProdCard)?>">
													</td>
												</tr>
											</table>
										</td>
								...
								<?php }?>
										<td width="1%" align="left" style="padding:10px 50px 10px 10px;" nowrap>
											...
											<button onClick="javascript:window.close();return false;"><?php echo(getTText("cancelar",C_UCWORDS)); ?>
											</button>
										</td>
									</tr>
								</table>	
