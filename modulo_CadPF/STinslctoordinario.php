...
<html>
	<head>
		...
		<!--
			...
			function ok() {
				strLocation = "../modulo_CadPF/STifrlancamento.php?var_chavereg=<?php echo($intCodTitulo)?>&var_cod_resize=<?php echo($intCodResize);?>";
				submeterForm();
			}

			function cancelar() {
				document.location.href = "../modulo_CadPF/STifrlancamento.php?var_chavereg=<?php echo($intCodTitulo)?>&var_cod_resize=<?php echo($intCodResize);?>";
			}

			function aplicar() {
				strLocation = "../modulo_CadPF/STinslctoordinario.php?var_chavereg=<?php echo($intCodTitulo)?>&var_cod_resize=<?php echo($intCodResize);?>";
				submeterForm();
			}
