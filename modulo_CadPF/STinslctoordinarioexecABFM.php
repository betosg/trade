...
if(!is_date($dateNumCred)) {  

	$dateNumCred = dateNow();
}
//elseif($dateNumCred > dateNow()) {  
...
try{
	$strSQL  = " INSERT INTO fin_lcto_ordinario (cod_conta_pagar_receber, tipo, codigo, cod_conta, cod_plano_conta, cod_centro_custo, historico, obs, num_lcto, dt_lcto, vlr_lcto, vlr_multa, vlr_juros, vlr_desc, sys_dtt_ins, sys_usr_ins, tipo_documento, num_documento, extra_documento, dt_cred) ";
	$strSQL .= " VALUES (" . $intCodDado . ", '" . $strTipo . "', " . $intCodigo . ", " . $intCodConta . ", " . $intCodPlanoConta . ", " . $intCodCentroCusto . ", '" . $strHistorico . "', '" . $strObs . "', '" . $strNumLcto . "', '" . $dateNumLctoNorm	. "', " . $dblVlrLctoNorm . ", " . $dblVlrMulta . ", " . $dblVlrJuros . ", " . $dblVlrDesc . ", CURRENT_TIMESTAMP, '" . getsession(CFG_SYSTEM_NAME . "_id_usuario") . "', '" . $strDocumento . "', '" . $numDocumento . "', '" . $strExtraDocumento . "','".$dateNumCred."') ";
