<?php
	...
	$TAG_NUM_MATRICULA = getValue($objRS,"num_matricula");
...
<body>
	<table width="378" height="245" cellpadding="0" cellspacing="0" border="0" background="../img/layout_credencial_sfoto.jpg" bgcolor="">
		<tr>
