...
<?php
	...
	try{
		$strSQL = "
			...
			INNER JOIN prd_pedido ON (fin_conta_pagar_receber.cod_pedido = prd_pedido.cod_pedido) 
			INNER JOIN cad_pf ON (prd_pedido.it_cod_pf = cad_pf.cod_pf) 
		...
		?>
			<tr bgcolor="<?php echo(getLineColor($strColor));?>">
				<td align="center" style="vertical-align:top;">
					<img src="../img/icon_ver_lancamento.gif" title="<?php echo(getTText("lancamentos",C_NONE));?>" onClick="showDetailGridT('<?php echo(getValue($objRS,"cod_conta_pagar_receber"));?>','../modulo_CadPF/STifrlancamento.php?var_cod_resize=<?php echo(request("var_chavereg"));?>','cod_conta_pagar_receber');" border="0" style="cursor:pointer;" />
				</td>
