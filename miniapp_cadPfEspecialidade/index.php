...
<?php
	...
	$strSQL = "	select t1.cod_pf_especialidade as codigo, t2.nome,t2.cod_especialidade
...
<body bgcolor="#FFFFFF">
	...
	<table cellpadding="0" cellspacing="0" width="100%" class="menu_css">
		<tr>
			...
			<?php
				athBeginCssMenu();
					athCssMenuAddItem("","_self","Especialidade",1);
					athBeginCssSubMenu();								
						athCssMenuAddItem("STinsespecialidade.php?var_codigo=".$intCodCadastro,"_self","Inserir");
					athEndCssSubMenu();
				athEndCssMenu();		
			?>
			</td>
	...
	if($objResult->rowCount() == 0) {
		mensagem("alert_consulta_vazia_titulo","alert_consulta_vazia_desc","Não há especialidades cadastradas.","","aviso",1,"","","");
	} else {
	?>
	...
	<table align="center" cellpadding="0" cellspacing="1" style="width:100%;" class="tablesort">
		<thead>
			<tr>
				...
				<th width="20%" class="sortable" nowrap>Especialidade</th>
			</tr>
		</thead>
		<tbody>
        	...
        	<tr bgcolor="<?php echo(getLineColor($strColor));?>">
				<td align="center" style="vertical-align:middle;">
					<img src="../img/icon_trash.gif" alt="deletar" 
						 ...
						 onClick="linkPage('STdelespecialidade.php?var_cod_dado=<?php echo(getValue($objRS,"codigo"));?>&var_cod_cad=<?PHP echo $intCodCadastro; ?>');" />				</td>
				<td align="center" style="vertical-align:middle;">
					<img src="../img/icon_write.gif" alt="editar" 
						 title="editar"
						 border="0" style="cursor:pointer;" 
						 onClick="linkPage('STupdespecialidade.php?var_cod_dado=<?php echo(getValue($objRS,"codigo"));?>&var_cod_cad=<?PHP echo $intCodCadastro; ?>&var_cod_especialidade=<?php echo(getValue($objRS,"cod_especialidade"));?>');" />				</td>
