...
<?php
	...
	try{
		...
		$strSQL = "	select t1.cod_pf_especialidade as codigo, t2.nome,t2.cod_especialidade
				...
				and cod_pf_especialidade = " . $intcodigo. "
				order by t2.nome";
...
<html>
	<head>
		...
		<script language="javascript" type="text/javascript">
			...
			function ok() {
				strLocation = "../miniapp_cadPfEspecialidade/index.php?var_chavereg=<?php echo $var_cod_cad;?>";
				submeterForm();
			}
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	<input type="hidden" name="DEFAULT_TABLE" 			value="cad_pf_especialidade" />
	<input type="hidden" name="DEFAULT_DB" 				value="<?php echo(CFG_DB);?>" />
	<input type="hidden" name="FIELD_PREFIX" 			value="DBVAR_" />
	<input type="hidden" name="RECORD_KEY_NAME" 		value="cod_pf_especialidade" />
