...
<?php
	...
	try{
		...
		$strSQL  = "
			...
			WHERE cad_pj.cod_pj = ".$intCodDado ." ";
...
<head>
	...
	<script language="javascript">
		...
		window.onload = function (){
			...
			window.parent.document.getElementById('<?php echo(CFG_SYSTEM_NAME); ?>_detailiframe_<?php echo($intCodDado); ?>').style.height = document.body.scrollHeight + 20;
...
<form name="formpf" action="STetiquetas.php" target="window" method="post" style="margin:0px;">
		...
		<?php
			athBeginCssMenu();
				...
				athBeginCssSubMenu();
					...
					athCssMenuAddItem("STviewpfs.php?var_chavereg=".$intCodDado."&var_tipo_consulta=NORM","_self",getTText("colabs_naohomologados_somente",C_NONE));
					athCssMenuAddItem("STviewpfs.php?var_chavereg=".$intCodDado."&var_tipo_consulta=HOMO","_self",getTText("colabs_homologados_somente",C_NONE));
					athCssMenuAddItem("STviewpfs.php?var_chavereg=".$intCodDado."&var_tipo_consulta=TODO","_self",getTText("colabs_todos",C_NONE));
				athEndCssSubMenu();
			athEndCssMenu();		
		?>
		</td>
	...
	<table bgcolor="<?php echo(CL_CORLINHA_1);?>" style="width:100%;  margin-bottom:0px;" class="tablesort">
		<thead>
			<tr>
				<th width="01%"></th><!-- EDIT -->
				<th width="01%"></th><!-- HOMO FAST -->
				<th width="01%"></th><!-- SOLIC CARD -->
				<th width="01%"></th><!-- IMPR CARD -->
				<th width="01%"></th><!-- ETIQUETA -->
				<th width="01%"></th><!-- INSERIR_LCTO -->
				<th width="01%"></th><!-- RECIBO -->
				<th width="10%" class="sortable-numeric" nowrap>COD</th>
				...
				<th width="08%" class="sortable-date-dmy" nowrap>ADMISSÃO</th>
				<th width="08%" class="sortable-date-dmy" nowrap>DEMISSÃO</th>
				<th width="01%"></th><!-- STATUS HOMO -->
				<th width="01%"></th><!-- STATUS PAGAMENTO -->
			</tr>
		</thead>
		<tbody>
	<?php
		...
		?>
			<tr>
				<td align="center">
					<img src="../img/icon_write.gif" title="<?php echo(getTText("editar",C_NONE));?>" onclick="document.location.href='STupdcolab.php?var_cod_pj=<?php echo($intCodDado);?>&var_chavereg=<?php echo(getValue($objRS,"cod_pf"));?>&var_cpf=<?php echo(getValue($objRS,"cpf"));?>';" style="cursor:pointer;" />
				</td>
				<td align="center">
...
<script type="text/javascript">
  ...
  resizeIframeParent('<?php echo(CFG_SYSTEM_NAME); ?>_detailiframe_<?php echo(request("var_chavereg")); ?>','100');
  // ----------------------------------------------------------------------------------------------------------
</script>
</html>
<?php
