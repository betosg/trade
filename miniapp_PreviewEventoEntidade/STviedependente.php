...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr>
	<td align="center">
	<?php athBeginFloatingBox("520","none",getTText("dependente_inserir_title",C_NONE)." (". getTText("visualizar",C_NONE).")",CL_CORBAR_GLASS_1); ?>
	<form name="formstatic" action="" method="POST">
	<input type="hidden" name="DEFAULT_TABLE" 			value="cad_cadastro_sub" />
	<input type="hidden" name="DEFAULT_DB" 				value="<?php echo(CFG_DB);?>" />
	<input type="hidden" name="FIELD_PREFIX" 			value="DBVAR_" />
	<input type="hidden" name="RECORD_KEY_NAME" 		value="COD_CADASTRO_SUB" />
			...
			<td align="left" valign="top" style="padding:10px 50px 0px 50px;">
				<table cellspacing="2" cellpadding="3" border="0" width="100%">
					...
					<tr bgcolor="<?php echo(getLineColor($strColor));?>">
						...
						<td width="73%" align="left"><?php echo(getValue($objRS,"dt_nasc"));?></td>
					</tr>
