...
<tr>
    ...
    <tr>
        ...
        <?php if(getValue($objRS,"historico") != "TAXA - PROVA ESPECIALISTA") {?>
            <input type="radio" name="tipo_pgto"  id="tipo_pgto" onClick="exibeForm('boleto')" ><span style="font-size:11px;"><strong>BOLETO</strong></span>&nbsp;&nbsp;&nbsp;
        
        
<!--            <input type="radio" name="tipo_pgto"  id="tipo_pgto" onClick="exibeForm('cartao')" ><span style="font-size:11px;"><strong>CARTÃO DE CRÉDITO</strong></span> //-->
        <?php } else {?>    
...
<script type="text/javascript">
		...
		$(document).ready(function() {
                            $.ajax({ type: "POST"
                                    , url: "../_boletos/STshowboletoBepayCartaoBoleto.php"                                    
									, data: data
