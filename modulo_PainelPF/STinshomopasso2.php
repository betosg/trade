<?php
	...
	// Tipo inserção ou não
	if($intCodPF == ""){
		// Define até RÓTULO
		$strRotulo 		  = "Cadastrar e Solicitar Homologação";
		$strNome  		  = "";
		$strApelido		  = "";
		$dtDataNasc       = "";
		$strSexo  		  = "m";
		...
		// Tipo de Alteração
		$strRotulo = "Alterar e Solicitar Homologação";
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%" align="center">
	<tr>
		...
		<?php athBeginFloatingBox("720","none","NOVA HOMOLOGAÇÃO (" . $strRotulo . ")",CL_CORBAR_GLASS_1); ?>
				...
				<tr> 
		  			<td align="center" valign="top" style="padding:20px 80px 0px 80px;">
						...
						<tr bgcolor="<?php getLineColor($strColor);?>">
							...
							<tr bgcolor="<?php getLineColor($strColor);?>">
								<td width="1%" align="right" valign="top" nowrap style="padding-right:5px;"><strong>*Nome Mãe:</strong></td>
								<td nowrap align="left" width="99%" >
									<input name="var_nome_mae" id="var_nome_mae" value="<?php echo($strNomeMae); ?>" type="text" size="50" maxlength="250" title="Nome Mãe"><span class="comment_med">&nbsp;</span>
								</td>
							</tr>
							<tr><td colspan="2" height="10" bgcolor="#FFFFFF">&nbsp;</td></tr>
							...
							<tr bgcolor="<?php getLineColor($strColor);?>">
								<td width="1%" align="right" valign="top" nowrap style="padding-right:5px;"><strong>*Função:</strong></td>
								<td nowrap align="left" width="99%" >
							...
							<tr bgcolor="<?php getLineColor($strColor);?>">
								<td width="1%" align="right" valign="top" nowrap style="padding-right:5px;"><strong>*Admissão:</strong></td>
								<td nowrap>
