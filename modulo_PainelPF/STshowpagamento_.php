...
//		51 8138-8573
	...
	if ($objResult -> rowCount() <=0){
		mensagem("Titulo Pago","Este titulo já consta como pago","","","",1);	
		die();
	}
...
<tr>
	...
	<tr>
		<td align="left" valign="top" style="padding:15Px 0px 0px 15px;">
		<span style="font-size:11px;"><strong>Escolha a forma de pagamento:</strong></span>
		</td>
    </tr>
    <tr>
		<td align="left" valign="top" style="padding:15Px 0px 0px 15px;">
            <input type="radio" name="tipo_pgto"  id="tipo_pgto" onclick="exibeForm('boleto')" ><span style="font-size:11px;"><strong>BOLETO</span></strong>&nbsp;&nbsp;&nbsp;
            <input type="radio" name="tipo_pgto"  id="tipo_pgto" onclick="exibeForm('cartao')" ><span style="font-size:11px;"><strong>CARTÃO DE CRÉDITO</span></strong>
		</td>
    </tr>
                ...
                <!--div id="dados_cartao" style="display:none;visibility:hidden;"-->
						...
						<tr>
							<td class="td40" colspan="2" align="left">
								...
								<span style="color: red;font-weight: bolder; font-size:15px" id="info">Clique aqui para baixar seu boleto</span></a>
...
<script type="text/javascript">
		...
		//console.log(data)
		var_dados = document.getElementById("var_tipo").value + "|" +
					document.getElementById("var_nome_cartao_ô").value + "|" +
					document.getElementById("cartao_var_cpf_titular_ô").value + "|" +
					document.getElementById("cartao_var_num_cartao_ô").value + "|" +
					document.getElementById("cartao_var_cod_cartao_ô").value + "|" +
					document.getElementById("cartao_var_mes_cartao_ô").value + "|" +
					document.getElementById("cartao_var_ano_cartao_ô").value + "|" +
					document.getElementById("bandeira").value + "|" +
					document.getElementById("var_cod_conta_pagar_receber").value+ "|" +
					document.getElementById("var_parcela_ô").value;

		//console.log(var_dados);
		$(document).ready(function() {
                            $.ajax({ type: "POST"
                                    , url: "../_boletos/STshowboletoBepayCartaoBoleto.php?var_dados="+var_dados
                                    //, data: data
                                    //, error: function(result){
									//	document.getElementById("btn_ok").style.display = "block";
									//	document.getElementById("btn_cancel").style.display = "block";
									//	document.getElementById("info").innerHTML = "Falha na transação, tente novamente";
									//}
