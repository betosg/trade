...
//		51 8138-8573
	...
	if ($objResult -> rowCount() <=0){
		...
		mensagem("Titulo Pago", "Problema na geração do arquivo HTML deste relatório","",  "","standarderro",1);	
		die();
	}
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <p><h1>Aguarde Processando Pagamento</h1></p>
  </div>
  ...
  if (event.target == modal) {
    modal.style.display = "none";
		...
		$(document).ready(function() {
                            $.ajax({ type: "POST"
                                    , url: "../_boletos/STshowboletoBepayCartaoBoletoNEW.php"                                    
									, data: data
