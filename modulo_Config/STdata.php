...
/***************************************************/
$arrArquivo    = file("../_database/" . ARQUIVO_LEITURA);

array_shift($arrArquivo); //Tira a primeira linha do arquivo - abertura da TAG PHP
array_pop($arrArquivo);   //Tira a ultima linha do arquivo - fechamento da TAG PHP
$arrArquivo = array_filter($arrArquivo,"filtro"); //Aplica o filtro no array do arquivo
...
<?php athBeginWhiteBox("98%"); ?>
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
						...
						<td>
							...
							<table id="tableContent" border="0" cellpadding="0" cellspacing="0" width="100%" background="../img/grid_backheader.gif" style="background-repeat:repeat-x;">
									...
									<td height="22">
										<table border="0" cellpadding="0" cellspacing="0" width="100%">
											<tr>
												...
												<td class="titulo_grade" width="99%" nowrap><?php echo(getTText("linha",C_UCWORDS)); ?></td>
											</tr>
										</table>
									</td>
									<td height="22">
										<table border="0" cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<!--td width="1%">
													<table border="0" cellpadding="0" cellspacing="0" width="100%">
														<tr><td><a href="javascript:setOrderBy('1','ASC');"><img src="../img/gridlnkASC.gif"  border="0" align="absmiddle"></a></td></tr>
														<tr><td><a href="javascript:setOrderBy('1','DESC');"><img src="../img/gridlnkDESC.gif" border="0" align="absmiddle"></a></td></tr>
													</table>
												</td-->
												<td class="titulo_grade" width="99%" nowrap><?php echo(getTText("indice",C_UCWORDS)); ?></td>
											</tr>
										</table>
									</td>
									<td height="22">
										<table border="0" cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<!--td width="1%">
													<table border="0" cellpadding="0" cellspacing="0" width="100%">
														<tr><td><a href="javascript:setOrderBy('2','ASC');"><img src="../img/gridlnkASC.gif"  border="0" align="absmiddle"></a></td></tr>
														<tr><td><a href="javascript:setOrderBy('2','DESC');"><img src="../img/gridlnkDESC.gif" border="0" align="absmiddle"></a></td></tr>
													</table>
												</td-->
												<td class="titulo_grade" width="99%" nowrap><?php echo(getTText("valor",C_UCWORDS)); ?></td>
											</tr>
										</table>
									</td>
								...
								<?php 
									...
									foreach($arrArquivoAux as $intLineNum  => $strLine) { 
										$strLine = trim($strLine);
										$intLineNum = $intLineNum + 2;
										...
										<table border="0" cellspacing="0" cellpadding="0" width="<?php echo(CL_LINK_WIDTH * NUM_ICONES); ?>">
											<tr>
												<td width="<?php echo(ICONES_WIDTH)?>">
													<?php if(strpos($arrLine[0],"@") === false) { ?>
													<a href="STdelete.php?var_chavereg=<?php echo($intLineNum); ?>"><img src="../img/icon_trash.gif" border="0"></a>
													<?php } ?>
												</td>
												<td width="<?php echo(ICONES_WIDTH); ?>">
													<?php if($arrLine[0] == "@CFG_SYSTEM_THEME") { ?>
													<a href="STsetcolor.php?var_chavereg=<?php echo($intLineNum); ?>"><img src="../img/icon_write.gif" border="0"></a>
													<?php } else { ?>
													<a href="STupdate.php?var_chavereg=<?php echo($intLineNum); ?>"><img src="../img/icon_write.gif" border="0"></a>
													<?php } ?>
												</td>
											</tr>
										</table>
									</td>
									<td height="22" align="left" style="padding:0px 5px;"><?php echo($intLineNum); ?></td>
									<td height="22" align="left" style="padding:0px 5px;"><?php echo((strpos($arrLine[0],"@") === 0) ? "<strong>" . $arrLine[0] . "</strong>" : $arrLine[0]); ?></td>
									<td height="22" align="left" style="padding:0px 5px;"><?php echo($strLineValor); ?></td>
								</tr>
								<?php
									}
								?>
		...
		<tr><td colspan="2" height="3"></td></tr>
		<?php if(!$boolIsExportation && GRADE_NUM_ITENS != 0){ ?>
		<tr>
