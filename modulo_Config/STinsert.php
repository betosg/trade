...
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
 <tr>
   <td align="center" valign="top">
	<?php athBeginFloatingBox("725","none","CONFIG (Inserção)",CL_CORBAR_GLASS_1); ?>
    <table id="dialog" width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:1px solid #A6A6A6;">
	    <form name="formstatic" action="STinsertexec.php" method="post">
				...
				<table width="550" border="0" cellspacing="0" cellpadding="4">
					<tr bgcolor="#FAFAFA">
						...
						<td>
							...
							<span class="comment_med"><?php echo(getTText("indice_desc_ins",C_NONE)); ?>.</span>
						</td>
					</tr>
					<tr bgcolor="#FFFFFF">
					...
					<!--tr bgcolor="#FAFAFA">
						<td width="1%" align="right" valign="top"><strong><?php echo(getTText("comentario",C_NONE)); ?>:</strong>&nbsp;</td>
						<td>
							<input type="text" name="var_comentario" value="" size="64"><br>
							<span class="comment_med">Não é necessário colocar os caracteres para comentário</span>
						</td>
					</tr>
					<tr bgcolor="#FFFFFF">
						<td width="1%" align="right" valign="top" nowrap><strong><?php echo(getTText("linhas_branco",C_NONE)); ?>:</strong>&nbsp;</td>
						<td>
							<select name="var_linhas_branco" style="width:50px;">
							...
							<select name="var_local_linhas" style="width:80px;">
								<option value="a">Antes</option>
								<option value="d">Depois</option>
							</select>
							<br>
							<span class="comment_med">Número de linhas em branco que virão antes ou depois do registro novo</span>
						</td>
					</tr-->
					<tr align="left">
