...
<html>
	<head>
		...
		<script language="javascript" type="text/javascript">
			...
			function cancelar() {
			//	document.location.href = "../miniapp_contatos_expo/index.php?var_chavereg=<?php echo $intcodigo; ?>";
			}
			...
			function sobrenome(){
				...
				if (var_NomeContato.length < 2) {alert("Você precisa inserir NOME E SOBRENOME para o contato.");document.getElementById("DBVAR_STR_CONTATO").focus();}
			}
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	<form name="formstatic" action="STinscontatoexec.php" method="POST" onSubmit="checkCPF(document.formstatic.DBVAR_STR_CPF.value,true);" />
			...
			<td align="left" valign="top" style="padding:10px 50px 0px 50px;">
				<table cellspacing="2" cellpadding="3" border="0" width="100%">
					...
					<tr bgcolor="<?php echo(getLineColor($strColor));?>">
						...
						<td width="73%" align="left"><input type="text" name="DBVAR_STR_CONTATO" id="DBVAR_STR_CONTATO" style="width:200px;" maxlength="99"/></td>
					</tr>					
					<tr bgcolor="<?php echo(getLineColor($strColor));?>">
						<td width="27%" align="right"><strong><?php echo(getTText("cargo",C_UCWORDS));?>:</strong></td>
						<td width="73%" align="left"> <input type="text" name="DBVAR_STR_CARGO" style="width:150px;" maxlength="30" />
						</td>
					</tr>
					<tr bgcolor="<?php echo(getLineColor($strColor));?>">
						<td width="27%" align="right"><strong><?php echo(getTText("cpf",C_TOUPPER));?>:</strong></td>
						<td width="73%" align="left"> 
							<input type="text" name="DBVAR_STR_CPF" maxlength="11" style="width:100px;" onBlur="checkCPF(this.value,true);"  />
					...
					<tr bgcolor="<?php echo(getLineColor($strColor));?>">
						...
						<td width="73%" align="left"><input type="text" name="DBVAR_STR_EMAIL" size="50" style="width:220px;" /></td>
					</tr>	
                    <tr bgcolor="<?php echo(getLineColor($strColor));?>">
						<td width="27%" align="right"><strong><?php echo(getTText("telefone1",C_UCWORDS));?>:</strong></td>
						<td width="73%" align="left"><input type="text" name="DBVAR_STR_FONE" size="50" style="width:220px;" /></td>
					</tr>					
				</table>
			</td>					
		</tr>																		
