// PartPage Plugin for HTMLArea-3.0
...
function PartPage(editor) {
	this.editor = editor;

	var cfg = editor.config;
	cfg.PartPage = false;
	var tt = PartPage.I18N;
	var self = this;

	cfg.registerButton("FP-docprop", tt["Document properties"], editor.imgURL("docprop.gif", "PartPage"), false,
			   function(editor, id) {
...
PartPage.prototype.buttonPress = function(editor, id) {
	var self = this;
	switch (id) {
	    case "FP-docprop":
		var doc = editor._doc;
		...
		editor._popupDialog("plugin://PartPage/docprop", function(params) {
...
PartPage.prototype.setDocProp = function(params) {
	var txt = "";
