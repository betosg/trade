      ...
      <tr valign="top">
        <td>
          <table border="0">
            ...
            <tr><td><img alt="mostrando a língua" border="0" hspace="10" src="carinhas/tongueout.gif"  onclick="insert('carinhas/tongueout.gif','mostrando a língua')" width="15" height="15" /></td><td>mostrando a língua</td><td class="smile">:-P</td></tr>
        ...
        <td>
          <table border="0" align="center">
            ...
            <tr><td><img alt="tímido" border="0" hspace="10" src="carinhas/shy.gif"  onclick="insert('carinhas/shy.gif','tímido')" width="15" height="15" /></td><td>tímido</td><td class="smile">8-.</td></tr>
            ...
            <tr><td><img alt="bufão" border="0" hspace="10" src="carinhas/clown.gif"  onclick="insert('carinhas/clown.gif','bufão')" width="15" height="15" /></td><td>bufão</td><td class="smile">:o)</td></tr>
            ...
            <tr><td><img alt="diabólico" border="0" hspace="10" src="carinhas/evil.gif"  onclick="insert('carinhas/evil.gif','diabólico')" width="15" height="15" /></td><td>diabólico</td><td class="smile">}-]</td></tr>
          </table>
        </td>
      </tr>
    </table>
