							...
							<?php
								...
								foreach($objRS as $strCampo => $strDado) {
									if($intI % 2 == 0) {
										...
										echo("
							<th height=\"22\" class=\"" . $strClass . "\">" . getTText(preg_replace("/(.*)__/","",$strCampo),C_NONE) . "</th>
											");
									}
									$intI++;
								}
				...
				<table border="0" cellpadding="0" cellspacing="0" class="grid_paging">
				  <form name="formpaginacao" action="datatblsort.php" method="post">
					...
					<tr>
						...
						<td style="padding:3px 10px 0px 10px;"><?php echo(getTText("pagina",C_TOLOWER)); ?> <input type="text" name="var_curpage" value="<?php echo($intNumCurPage)?>" size="3"> <?php // echo(getTText("de",C_TOLOWER) . " " . $intTotalPaginas); ?></td>
