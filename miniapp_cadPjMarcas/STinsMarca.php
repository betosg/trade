...
<html>
	<head>
		...
		<script language="javascript" type="text/javascript">
			...
			function cancelar() {
				window.location = "../miniapp_cadPjMarcas/index.php?var_chavereg=<?php echo $intcodigo;?>";
			}
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	<form name="formstatic" action="STinsMarcaExec.php" method="POST" />
		...
		<tr>
			<td align="left" valign="top" style="padding:10px 50px 0px 50px;">
				<table cellspacing="2" cellpadding="3" border="0" width="100%">
					...
					<tr bgcolor="<?php echo(getLineColor($strColor));?>">
						<td width="27%" align="right"><strong>Marcas</strong></td>
						<td width="73%" align="left">
                            <input type="text" name="DBVAR_STR_MARCA" id="DBVAR_STR_MARCA" style="width:300px;" maxlength="255" value=""/>							
					</tr>
