...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	<form name="formstatic" action="STupdMarcaExec.php" method="POST" />
				...
				<table cellspacing="2" cellpadding="3" border="0" width="100%">
					...
					<tr bgcolor="<?php echo(getLineColor($strColor));?>">
						...
						<td width="73%" align="left">
							...
							<input type="hidden" name="dbvar_codigo_marca" id="dbvar_codigo_marca" value="<?php echo(getValue($objRS,"codigo"))?>"style="width:200px;" maxlength="99" />							
					...
					<tr bgcolor="<?php echo(getLineColor($strColor));?>">
						...
						<td width="73%" align="left">
                            <input type="text" name="DBVAR_STR_MARCA" id="DBVAR_STR_MARCA" style="width:200px;" maxlength="255" value="<?php echo(getValue($objRS,"marca"))?>"/>							
					</tr>			
				</table>
			</td>					
		</tr>																		
