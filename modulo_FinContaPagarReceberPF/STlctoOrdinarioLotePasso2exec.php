...
try {
	$strSQL = "	SELECT out_cod_pj, out_cod_conta_pagar_receber
				FROM sp_efetua_lcto_ordinario_em_lote('".$strSituacao."','".$strCategoria."',".$intCodSegmento.",".$intCodCategoriaExtra.",'".$dateDtVctoIni."','".$dateDtVctoFim."','".$strTipoDocumento."','".$dateDtPgto."','".$strOpcaoPgto."',".$dblVlrPgto.",'".$strObs."','".getsession(CFG_SYSTEM_NAME."_id_usuario")."') ";
