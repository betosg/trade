...
<html>
	<head>
		...
		<!--
			...
			function ok() {
				strLocation = "../modulo_FinContaPagarReceberPF/STifrlancamentoABFM.php?var_chavereg=<?php echo($intCodTitulo)?>";
				submeterForm();
			}

			function cancelar() {
				document.location.href = "../modulo_FinContaPagarReceberPF/STifrlancamentoABFM.php?var_chavereg=<?php echo($intCodTitulo)?>";
			}

			function aplicar() {
				strLocation = "../modulo_FinContaPagarReceberPF/STinslctoordinarioABFM.php?var_chavereg=<?php echo($intCodTitulo)?>";
				submeterForm();
			}
				...
				<tr>
					<td align="center" valign="top">
						<table width="500" border="0" cellspacing="0" cellpadding="4">
							...
							<tr> 
								<td align="right" valign="middle">*<b><?php echo(getTText("data",C_UCWORDS)); ?> Pgto:</b>&nbsp;</td>
