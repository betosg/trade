...
<?php
	...
	try {
		...
		$strSQL = "	
			...
			ORDER BY fin_lcto_ordinario.dt_cred ASC, fin_conta_pagar_receber.cod_conta_pagar_receber DESC";
			...
			<td align="left">
				<?php
					...
					athBeginCssMenu();
						...
						athBeginCssSubMenu();
							athCssMenuAddItem("../modulo_FinContaPagarReceberPF/STinslctoordinarioABFM.php?var_chavereg=".$intCodTitulo,
	...
	<table align="center" cellpadding="0" cellspacing="1" style="width:100%" class="tablesort">
		<thead>
			<tr>
				...
				<th width="10%" nowrap><?php echo(getTText("data",C_NONE));?> Créd.</th>
				<th width="10%" nowrap><?php echo(getTText("data",C_NONE));?> Pgto.</th>
