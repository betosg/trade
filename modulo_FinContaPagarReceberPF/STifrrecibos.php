...
<?php
	...
	try{
		$strSQL = "
			...
			FROM 
				fin_recibo
			WHERE fin_recibo.cod_conta_pagar_receber = ".$intCodDado."
			...
			<td align="left">
				<?php
					...
					athBeginCssMenu();
						...
						athBeginCssSubMenu();
							athCssMenuAddItem("../modulo_FinContaPagarReceberPF/STshowrecibo.php?var_chavereg=".$intCodDado,"_self",getTText("recibo_inserir",C_NONE));
						athEndCssSubMenu();
					athEndCssMenu();		
				?>
			</td>
