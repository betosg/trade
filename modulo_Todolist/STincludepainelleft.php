...
<?php athBeginShapeBox("200","","<span style='float:right;padding-right:3px;'><img src='../img/icon_tree_plus.gif' border='0' onClick=\"showArea('grupo_0','grupo_img_0');\" id='grupo_img_0' style='cursor:pointer' /></span>".getTText("bookmark",C_NONE),CL_CORBAR_GLASS_2); ?>
<div id="grupo_0" style="display:none;">
<table cellpadding="0" cellspacing="0" border="0" width="100%">
<tr>
...
<?php athBeginFloatingBox("100%","","<span style='float:right;padding-right:3px;'><img src='../img/icon_tree_minus.gif' border='0' onClick=\"showArea('grupo_1','grupo_img_1');\" id='grupo_img_1' style='cursor:pointer' /></span><strong>".getTText("tarefas_vencidas",C_NONE)."</strong>",CL_CORBAR_GLASS_2);?>
<div id="grupo_1" style="display:block;">
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr><td align="center" valign="top"><?php include_once("STtarefasvencidas.php"); ?></td></tr>
	</table>
</div>
...
<div id="grupo_2" style="display:block;">
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr><td align="center" valign="top"><?php include_once("STtarefasdodia.php"); ?></td></tr>
	</table>
</div>
<?php athEndFloatingBox();?>
...
<?php athBeginFloatingBox("100%","","<span style='float:right;padding-right:3px;'><img src='../img/icon_tree_minus.gif' border='0' onClick=\"showArea('grupo_3','grupo_img_3');\" id='grupo_img_3' style='cursor:pointer' /></span><strong>".getTText("proximas_tarefas",C_NONE)."</strong>",CL_CORBAR_GLASS_2);?>
<div id="grupo_3" style="display:block;">
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr><td align="center" valign="top"><?php include_once("STtarefasadiantadas.php"); ?></td></tr>
	</table>
</div>
<?php athEndFloatingBox();?>
</center>