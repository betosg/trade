<?php
	...
	$intCodAtividade = request("var_cod_atividade");
	...
	if((getsession(CFG_SYSTEM_NAME."_id_usuario") != getValue($objRS,"id_responsavel")) && (getsession(CFG_SYSTEM_NAME."_id_usuario") != getValue($objRS,"id_ult_executor"))){
		if($intCodAtividade != ""){
		mensagem("err_sql_titulo","tarefa_nao_te_pertence","",$strLocation,"aviso",1,"1");
		} else{
		mensagem("err_sql_titulo","tarefa_nao_te_pertence","",$strLocation,"aviso",1);
		}
		die();
	}
	...
	if(getValue($objRS,"situacao") == "fechado"){
		if($intCodAtividade != ""){
		mensagem("err_sql_titulo","aviso_tarefa_ja_fechada","",$strLocation,"aviso",1,"1");
		} else{
